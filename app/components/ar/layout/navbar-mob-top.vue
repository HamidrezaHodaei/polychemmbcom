<!-- /components/ar/layout/navbar-mob-top.vue -->
<template>
  <div class="app-container">
    <nav class="navbar">
      ...
      <div class="right-section">
        <button class="menu-btn font-arabic" @click="toggleMenu">
          {{ menuOpen ? 'إغلاق' : 'المنتجات' }}
        </button>
      ...
      <div v-if="langMenuOpen" class="glass-menu-fullscreen">
        <div class="menu-scroll-wrapper">
          <ul class="menu-list">
            ...
            <li class="menu-item font-arabic" :class="{ active: currentLang === 'ar' }" @click="handleLangClick('ar')">
              العربية
            </li>
...
const useCases = [
  { title: 'ROTOCHEM 0955W', index: 0, slug: '0955W' },
  { title: 'ROTOCHEM 0955B', index: 1, slug: '0955B' },
  { title: 'POLYFIL F700', index: 2, slug: 'POLYFIL-F700' },
  { title: 'POLYFIL 1300 EWA', index: 3, slug: 'POLYFIL-1300-EWA' },
  { title: 'HDCHEM 4760', index: 4, slug: 'HDCHEM-4760' },
  { title: 'SlIPCHEM E 178', index: 5, slug: 'SlIPCHEM-E-178' },
  { title: 'RAFCOLOR 1560', index: 6, slug: 'RAFCOLOR-1560' },
  { title: 'CALCICHEM 126 FP', index: 7, slug: 'CALCICHEM-126-FP' },
  { title: 'CALCICHEM 110 FRF', index: 8, slug: 'CALCICHEM-110-FRF' },
  { title: 'CALCICHEM 275 PM', index: 9, slug: 'CALCICHEM-275-PM' },
  { title: 'UVCHEM MB-R18', index: 10, slug: 'UVCHEM-MB-R18' },
]
...
const navigateToProduct = (product) => {
  ...
  showChatbox()
  const lang = currentLang.value || 'ar'
  const productPath = product.slug ? `/${lang}/products/${product.slug}` : `/${lang}/products`
  if (process.client) {
    document.body.style.overflow = ''
