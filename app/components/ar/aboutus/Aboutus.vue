...
<template>
 ...
 <div class="text-section font-[Tajawal]" dir="">
  <h2> POLYCHEM</h2>
  <p class="text-justify" dir="rtl">
    بولي كيم شركة متخصصة في تصنيع المركبات البوليمرية المتقدمة والماستر باتش، مقرها في منطقة آراس الحرة. نحن نؤمن بأن جودة المنتج النهائي تبدأ باختيار المواد الخام الصحيحة. بولي كيم هي نتيجة الجمع بين خبرة الصناعة لسنوات مع خبرة الباحثين الشباب.
  </p>
  <h4>ما هي نقاط تركيزنا؟</h4>
  <ul dir="rtl">
    <li>الإنتاج المتخصص: تقديم مركبات بوليمرية هندسية عالية الجودة وماستر باتش.</li>
    <li>البحث والتطوير: تعريب المعرفة التقنية ونقل التكنولوجيا الحديثة.</li>
    <li>الدعم الفني: توفير الاستشارات الهندسية وتصميم العمليات الدقيقة للإنتاج.</li>
  </ul>
  <p dir="rtl">
    في بولي كيم، نحول الابتكار والخبرة إلى حلول موثوقة وعالية الجودة للصناعات التي تتطلب أداءً عالياً.
  </p>
  <NuxtLink to="/ar/careers" class="btn-slide-down read-more">
    <span class="btn-text">انضم إلينا...</span>
  </NuxtLink>
</div>
...
/* --- Desktop Text --- */
.text-section h2 { font-size: 50px; font-weight: 700; color: #848484; font-family: 'Tajawal', -apple-system, BlinkMacSystemFont, sans-serif; }
.text-section h4 { font-size: 26px; font-weight: 600; color: #848484; font-family: 'Tajawal', -apple-system, BlinkMacSystemFont, sans-serif; }
.text-section p  { font-size: 15px; color: #848484; line-height: 28px; font-family: 'Tajawal', -apple-system, BlinkMacSystemFont, sans-serif; }
.text-section ul {
  list-style: disc; padding-left: 1.25rem;
  color: #848484; line-height: 1.9; font-size: 14px; font-family: 'Tajawal', -apple-system, BlinkMacSystemFont, sans-serif;
}
...
.read-more {
  ...
  margin-top: 4px; font-family: 'Tajawal', -apple-system, BlinkMacSystemFont, sans-serif;
}
