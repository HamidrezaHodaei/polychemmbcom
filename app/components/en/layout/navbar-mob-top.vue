<!-- /components/en/layout/navbar-mob-top.vue -->
<template>
...
// ✅ فقط overflow رو قفل می‌کنیم — position: fixed نمی‌زنیم تا iOS اسکرول منو کار کنه
...
const useCases = [
  { title: 'ROTOCHEM 0955W', path: '/en/products/0955W' },
  { title: 'ROTOCHEM 0955B', path: '/en/products/0955B' },
  { title: 'POLYFIL F700', path: '/en/products/POLYFIL-F700' },
  { title: 'POLYFIL 1300 EWA', path: '/en/products/POLYFIL-1300-EWA' },
  { title: 'HDCHEM 4760', path: '/en/products/HDCHEM-4760' },
  { title: 'SlIPCHEM E 178', path: '/en/products/SlIPCHEM-E-178' },
  { title: 'RAFCOLOR 1560', path: '/en/products/RAFCOLOR-1560' },
  { title: 'CALCICHEM 126 FP', path: '/en/products/CALCICHEM-126-FP' },
  { title: 'CALCICHEM 110 FRF', path: '/en/products/CALCICHEM-110-FRF' },
  { title: 'CALCICHEM 275 PM', path: '/en/products/CALCICHEM-275-PM' },
  { title: 'UVCHEM MB-R18', path: '/en/products/UVCHEM-MB-R18' },
]
...
/* ✅ منوی fullscreen — خودش اسکرول می‌کنه */
.glass-menu-fullscreen {
  ...
  z-index: 9999999;
  /* ✅ کلیدی: overflow روی container اصلی */
  overflow-y: auto;
  overflow-x: hidden;
...
/* ✅ wrapper داخلی که padding و min-height داره */
.menu-scroll-wrapper {
  width: 100%;
  min-height: 100%;
