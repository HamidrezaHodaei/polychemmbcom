<!-- /components/fa/layout/navbar-mob-top.vue -->
<template>
  <div class="app-container">
    <nav class="navbar">
      ...
      <div class="right-section">
        <button class="menu-btn font-iranyekan" @click="toggleMenu">
          <span v-if="!menuOpen">محصولات</span>
...
const productPathMap = {
  0: '/fa/products/0955W',
  1: '/fa/products/0955B',
  2: '/fa/products/POLYFIL-F700',
  3: '/fa/products/POLYFIL-1300-EWA',
  4: '/fa/products/HDCHEM-4760',
  5: '/fa/products/SlIPCHEM-E-178',
  6: '/fa/products/RAFCOLOR-1560',
  7: '/fa/products/CALCICHEM-126-FP',
  8: '/fa/products/CALCICHEM-110-FRF',
  9: '/fa/products/CALCICHEM-275-PM',
  10: '/fa/products/UVCHEM-MB-R18',
}
...
const navigateToProduct = (product) => {
  ...
  showMobileNavbar()
  showChatbox()
  const path = productPathMap[product.index] || '/fa/products'
  if (process.client) {
    document.body.style.overflow = ''
