...
@media (min-width: 1024px) and (max-width: 1365px) and (min-resolution: 120dpi) {
  .globe-side { width: 47%; height: 100%; }
  .text-side  { width: 53%; height: 100%; padding: 0 16px; }
}

@media (min-width: 1366px) and (min-resolution: 120dpi) {
  .globe-side { width: 48%; height: 100%; }
  .text-side  { width: 52%; height: 100%; padding: 0 16px; }
}

/* ===== 150% ZOOM (Desktop) ===== */
@media (min-width: 1024px) and (max-width: 1365px) and (min-resolution: 144dpi) {
  .globe-side { width: 46%; height: 100%; }
  .text-side  { width: 54%; height: 100%; padding: 0 12px; }
}
