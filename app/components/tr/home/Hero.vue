<template>
  <div class="hero-container">
    ...
    <div class="bg-wrapper">
      ...
      <!-- Poster shown only while the first video of the visit is loading -->
      <img
        v-if="showPoster"
        class="bg-poster"
        :src="posterSrc"
    ...
    <figure class="content-box">
      <h1 class="main-title text-bold">
        POLYCHEM
        <span class="subtitle">Polimer Mühendisliği</span>
      </h1>
      <figcaption>
        <p class="intro-text">
  POLYCHEM, Aras Özelleştirme Zone'ında bir profesyonel polimer kompozisyon ve masterbattı üretmek için özel bir üretici. Daha yüksek performans veren materiallerin modern üretimde kullanmak için yaratılan hafif kaliteler.
        </p>
      </figcaption>
    </figure>
  </div>
...
/* Poster (shown only during first video load) */
.bg-poster {
  position: absolute;
  top: 0;
  left: 0;
