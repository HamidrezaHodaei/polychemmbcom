...
<template>
 ...
 <div class="text-section font-[Montserrat]" dir="ltr">
  ...
  <p class="text-justify">
    POLYCHEM, Aras Serbest Bölgesi merkezli, ileri polimer bileşikleri ve masterbatch üretiminde uzman bir üreticidir. Nihai ürünün kalitesinin, doğru hammadde seçimiyle başladığına inanıyoruz. POLYCHEM, yılların sektör tecrübesini genç araştırmacıların uzmanlığı ile birleştirmenin sonucudur.
  </p>
  <h4>Odak Noktamız Nedir?</h4>
  <ul dir="ltr">
    <li>Özel Üretim: Yüksek kaliteli mühendislik polimer bileşikleri ve masterbatchler sunmak.</li>
    <li>Ar-Ge: Teknik bilgi birikimini yerelleştirmek ve yeni teknolojileri aktarmak.</li>
    <li>Teknik Destek: Üretim için mühendislik danışmanlığı ve hassas proses tasarımı sağlamak.</li>
  </ul>
  <p dir="ltr">
    POLYCHEM’de yenilik ve uzmanlığı, yüksek talep gören endüstriler için güvenilir, yüksek kaliteli çözümlere dönüştürüyoruz.
  </p>
  <NuxtLink to="/tr/careers" class="btn-slide-down read-more">
    <span class="btn-text">Bize Katılın...</span>
  </NuxtLink>
</div>
