...
const PAGE_PATH = '/ar/products/0955B'
...
const product = {
  ...
  "brand": "",
  "subtitleTitle": "الوصف",
  "subtitle": "ROTOCHEM 955B هو خليط بوليمري متخصص أزرق اللون، مصمم لتطبيقات القولبة الدورانية. هذا المنتج عبارة عن مزيج من درجة كوبوليمر البولي إيثيلين متوسط الكثافة الخطي ذو توزيع ضيق للوزن الجزيئي مع صبغة زرقاء.",
  ...
  "detailSections": [
    {
      "title": "المميزات",
      "body": "من مميزات ROTOCHEM 955B: تشتت ممتاز، ومقاومة عالية للصدمات، وجودة سطحية عالية من الداخل والخارج، ومقاومة للتشقق الناتج عن الإجهاد البيئي (ESCR)، واستقرار فعّال ضد أشعة UV."
    },
    {
      "title": "التغليف",
      "body": "يُوزَّع ROTOCHEM 955B على شكل مسحوق في أكياس سعة 20 كيلوغرام."
    },
    {
      "title": "التخزين والمناولة",
      "body": "يُنصح بتخزين ROTOCHEM 955B بعيداً عن أشعة الشمس المباشرة والحرارة. يجب أن تكون بيئة التخزين جافة وألا تتجاوز درجة الحرارة 50 درجة مئوية. أفضل وقت للاستخدام هو خلال 18 شهراً من تاريخ الإنتاج."
    }
  ],
  "specs": [
    {
    ...
    {
      "property": "نسبة الرماد",
      "testMethod": "-",
      "unit": "%",
      "typicalValue": "0.3 – 0.5"
    },
    {
  ...
  "dataSheet": "/Product/Datasheet-AR/0955B AR.pdf"
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'ROTOCHEM 0955B | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'ROTOCHEM 955B هو خليط بوليمري متخصص أزرق اللون، مصمم لتطبيقات القولبة الدورانية. هذا المنتج عبارة عن مزيج من درجة كوبوليمر البولي إيثيلين متوسط الكثافة...'
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/products/0955B` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/products/0955B` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/products/0955B` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/products/0955B` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/products/0955B` },
  ],
  script: [
