<!-- /pages/ar/products/MBR18.vue -->
<template>  <div dir="rtl" style="font-family: 'Tajawal', -apple-system, BlinkMacSystemFont, sans-serif;">  <!-- ===================================================================== -->
  <!-- MOBILE LAYOUT                                                          -->
  <!-- ===================================================================== -->
  <div v-if="isMobile" class="page-wrap">
    ...
    <nav class="navbar">
      <div class="logo-container">
        <a @click.prevent="goHome" class="block cursor-pointer">
          <img src="/english logo W1.png" alt="شعار بوليكم" class="logo" />
        </a>
      </div>
    ...
    <div class="content-below-navbar">
      ...
      <div class="bg-[#A8A8A8] text-white px-5 py-8">
        <h3 class="font-semibold tracking-widest text-lg mb-6 text-[#FFCD05]">المواصفات الفنية</h3>
        <div class="space-y-3">
          <div
      ...
      <div class="px-5 py-6 bg-page-bg">
        <div class="cta-stack-mobile">
          <div class="cta-pair-mobile">
            ...
            >
              <span>تحميل صحيفة البيانات</span>
            </a>
          </div>
        </div>
      </div>
    ...
    <div class="shell">
      <header class="header">
        <nav class="nav">
          ...
          <a class="nav-item effect-1-yellow" href="#" title="المنتجات" @click.prevent="goToProducts">
        ...
        <div class="logo">
          <img src="/Polychem-1.png" alt="شعار بوليكم" class="logo-image" />
        </div>
      ...
      <main class="main-grid">
        <div class="left-col">
          <div class="hero-image">
            <img :src="product.heroImage" :alt="product.title + ' - صورة المنتج'" class="hero-photo" loading="lazy" />
          </div>
        </div>
...
const PAGE_PATH = '/ar/products/MBR18'
...
const product = {
  ...
  "brand": "",
  "subtitleTitle": "الوصف",
  "subtitle": "UVCHEM MB-R18 هو ماستر باتش مثبّت للأشعة فوق البنفسجية (UV) عالي الأداء، مُصمَّم للاستخدام في خيوط الرافيا والأقمشة المنسوجة. يحتوي هذا المنتج على مزيج تكافلي من المثبّطات الضوئية الأمينية المجانسة (HALS) وماصّات الأشعة فوق البنفسجية (UV Absorbers).",
  ...
  "detailSections": [
    {
      ...
      "body": "• شرائط وأكياس منسوجة من رافيا البولي بروبيلين\n• أفلام تعبئة زراعية وصناعية\n• مونوفيلامنت وحبال PP"
    },
    {
      "title": "المميزات",
      "body": "• مقاومة ممتازة للأشعة فوق البنفسجية وثبات لوني طويل الأمد\n• الحفاظ على خصائص الشد والاستطالة عند التعرض المطوّل لأشعة الشمس\n• توافق ممتاز مع PP\n• حبيبات خالية من الغبار وسهلة التغذية لضمان تشغيل منتظم وثابت"
    },
    {
      "title": "نسبة الإضافة المعتادة",
      "body": "للحصول على حماية مثلى، يُنصح بإضافة 1% وزنياً من UVCHEM MB-R18 أثناء عملية البثق. في البيئات المكشوفة ذات الإشعاع العالي، يمكن رفع الجرعة إلى 1.5-2% وزنياً."
    },
    {
      "title": "التغليف",
      "body": "يُعرض UVCHEM MB-R18 على شكل حبيبات في أكياس سعة 25 كيلوغرام."
    },
    {
      "title": "التخزين والمناولة",
      "body": "يجب تخزين UVCHEM MB-R18 بعيداً عن أشعة الشمس المباشرة والحرارة وألا تتجاوز درجة حرارة التخزين 40 درجة مئوية. يُستخدم خلال 12 شهراً من تاريخ الإنتاج."
    }
  ],
  "specs": [
    {
      "property": "المظهر الخارجي",
      "testMethod": "Visual",
      "unit": "–",
      "typicalValue": "Off-white to light beige"
    },
    {
      "property": "مؤشر تدفق المصهور (230°C / 2.16 kg)",
      "testMethod": "ASTM D1238",
      "unit": "g/10 min",
      "typicalValue": "7 – 9"
    },
    {
      "property": "الكثافة عند 23°C",
      "testMethod": "ASTM D792",
      "unit": "g/cm³",
      "typicalValue": "0.91"
    },
    {
      "property": "نسبة المواد المتطايرة (2h @ 220°C)",
      "testMethod": "TGA",
      "unit": "wt.%",
      "typicalValue": "< 1"
    },
    {
      "property": "الاستقرار الحراري (5% فقدان وزن)",
      "testMethod": "TGA",
      "unit": "°C",
      "typicalValue": "> 280"
    },
    {
      "property": "الحماية من الأشعة فوق البنفسجية",
      "testMethod": "ASTM D4329",
      "unit": "-",
      "typicalValue": "> 90% retention of tensile strength after 500 h QUV"
    }
  ],
  "dataSheet": "/Product/Datasheet-AR/UVCHEM MB-R18 AR.pdf"
}

// ─── Desktop accordion specs (same content as product.specs / sections) ──
const specs = ref([
  { id: 'advantage', title: product.detailSections[0].title, content: product.detailSections[0].body, open: true },
  { id: 'packaging', title: product.detailSections[1].title, content: product.detailSections[1].body, open: true },
  { id: 'storage_and_handling', title: product.detailSections[2] ? product.detailSections[2].title : '', content: product.detailSections[2] ? product.detailSections[2].body : '', open: true },
  { id: 'techspecs', title: 'المواصفات الفنية', isTable: true, open: true },
])
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'UVCHEM MB R18 | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'UVCHEM MB-R18 هو ماستر باتش مثبّت للأشعة فوق البنفسجية (UV) عالي الأداء، مُصمَّم للاستخدام في خيوط الرافيا والأقمشة المنسوجة. يحتوي هذا المنتج على مزيج...'
...
const breadcrumbJsonLd = computed(() => ({
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'المنتجات', item: `${SITE_URL}/ar/products` },
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/products/MBR18` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/products/MBR18` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/products/MBR18` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/products/MBR18` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/products/MBR18` },
  ],
  script: [
