...
const PAGE_PATH = '/ar/products/1560'
...
const product = {
  ...
  "brand": "",
  "subtitleTitle": "الوصف",
  "subtitle": "RAFCOLOR 1560 هو ماستر باتش أبيض على قاعدة بولي بروبيلين مع نسبة عالية من ثاني أكسيد التيتانيوم. يتميز هذا الماستر باتش بتشتت وثبات حراري ممتازين، ويصلح للاستخدام في إنتاج منتجات متنوعة.",
  ...
  "detailSections": [
    {
      "title": "المميزات",
      "body": "يتميز RAFCOLOR 1560 بـ: تشتت ممتاز، وتغطية عالية، وقابلية معالجة جيدة، وامتصاص منخفض للرطوبة، وخصائص ثابتة."
    },
    {
      "title": "التغليف",
      "body": "يُعرض ماستر باتش RAFCOLOR 1560 على شكل حبيبات في أكياس سعة 25 كيلوغرام."
    },
    {
      "title": "التخزين والمناولة",
      "body": "يُنصح بتخزين RAFCOLOR 1560 بعيداً عن أشعة الشمس المباشرة والحرارة. أفضل وقت للاستخدام هو خلال 18 شهراً من تاريخ الإنتاج."
    }
  ],
  "specs": [
    {
      "property": "نسبة المواد المعدنية",
      "testMethod": "-",
      "unit": "%",
      "typicalValue": "60 ± 2"
    },
  ...
  "dataSheet": "/Product/Datasheet-AR/RAFCOLOR  1560 AR.pdf"
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'RAFCOLOR 1560 | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'RAFCOLOR 1560 هو ماستر باتش أبيض على قاعدة بولي بروبيلين مع نسبة عالية من ثاني أكسيد التيتانيوم. يتميز هذا الماستر باتش بتشتت وثبات حراري ممتازين، ويصلح...'
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/products/1560` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/products/1560` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/products/1560` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/products/1560` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/products/1560` },
  ],
  script: [
