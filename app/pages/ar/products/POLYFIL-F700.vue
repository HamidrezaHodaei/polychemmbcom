...
const PAGE_PATH = '/ar/products/F700'
...
const product = {
  ...
  "brand": "",
  "subtitleTitle": "الوصف",
  "subtitle": "POLYFIL F700 هو كومباوند بولي إيثيلين مُصمَّم خصيصاً لتطبيقات أفلام البولي إيثيلين عالي الكثافة المنفوخ (HDPE Blown Film). هذه الدرجة مصممة لتوفير خصائص ميكانيكية مثالية وتجانس ممتاز للفيلم وقابلية معالجة جيدة حتى في إنتاج الأفلام الرقيقة جداً.",
  ...
  "detailSections": [
    {
      "title": "المميزات",
      "body": "• مقاومة شد عالية مع مقاومة جيدة للصدمات\n• نسبة جيل منخفضة لإنتاج أفلام ناعمة وخالية من العيوب\n• صلابة عالية تضمن استقراراً أبعادياً مناسباً للمنتج\n• نطاق درجة حرارة تشغيل واسع ومقاومة لأشعة UV\n• قابلية معالجة ممتازة على خطوط إنتاج أفلام HDPE القياسية"
    },
    {
      "title": "دليل عملية الإنتاج",
      "body": "درجة حرارة الانصهار: 190-210 درجة مئوية\nنسبة Blow Up Ratio: 3 إلى 5\nFrost Line Height: 8 إلى 10 أضعاف قطر القالب"
    },
    {
      "title": "التغليف",
      "body": "يُعرض POLYFIL F700 على شكل حبيبات في أكياس سعة 25 كيلوغرام."
    },
    {
      "title": "التخزين والمناولة",
      "body": "يُنصح بتخزين POLYFIL F700 بعيداً عن أشعة الشمس المباشرة والحرارة. أفضل وقت للاستخدام هو خلال 12 شهراً من تاريخ الإنتاج."
    }
  ],
  "specs": [
    {
      ...
      "testMethod": "ISO 1133",
      "unit": "g/10min",
      "typicalValue": "0.19 ± 0.1"
    },
    {
      "property": "الكثافة عند 23°C",
      "testMethod": "ISO 1183",
      "unit": "kg/m³",
      "typicalValue": "0.952 ± 0.003"
    },
    {
    ...
    {
      "property": "نقطة الانصهار",
      "testMethod": "ASTM D2117",
      "unit": "°C",
      "typicalValue": "135 ± 5"
    },
    {
      "property": "نقطة التليين (Vicat)",
      "testMethod": "ASTM D1525",
      "unit": "°C",
      "typicalValue": "124"
    },
    {
      "property": "مقاومة الشد عند نقطة الخضوع (MD)",
      "testMethod": "ASTM D638",
      "unit": "MPa",
      "typicalValue": "24"
    },
    {
      "property": "نسبة الاستطالة عند الكسر (MD, TD)",
      "testMethod": "ASTM D638",
      "unit": "%",
      "typicalValue": "450, 240"
    },
    {
      "property": "مقاومة التشقق الإجهادي البيئي",
      "testMethod": "ASTM D1693",
      "unit": "HR",
      "typicalValue": "> 1000"
    }
  ],
  "dataSheet": "/Product/Datasheet-AR/POLYFIL F700 AR.pdf"
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'POLYFIL F700 | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'POLYFIL F700 هو كومباوند بولي إيثيلين مُصمَّم خصيصاً لتطبيقات أفلام البولي إيثيلين عالي الكثافة المنفوخ (HDPE Blown Film). هذه الدرجة مصممة لتوفير خصائص...'
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/products/F700` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/products/F700` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/products/F700` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/products/F700` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/products/F700` },
  ],
  script: [
