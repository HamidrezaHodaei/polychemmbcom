...
const PAGE_PATH = '/ar/products/4760'
...
const product = {
  ...
  "brand": "",
  "subtitleTitle": "الوصف",
  "subtitle": "HDCHEM 4760 هو كومباوند بلاستيكي متخصص مصمم لتطبيقات القولبة بالنفخ (Blow Molding). هذا المنتج عبارة عن مزيج من كوبوليمرات البولي إيثيلين ويتمتع بمجموعة من الخصائص المثالية والعملية.",
  ...
  "detailSections": [
    {
      "title": "المميزات",
      "body": "من مميزات HDCHEM 4760: انسيابية مناسبة، ومقاومة عالية للصدمات، ومقاومة جيدة للتشقق الناتج عن الإجهاد البيئي (ESCR)، وصلابة مثالية."
    },
    {
      "title": "التغليف",
      "body": "يُعرض HDCHEM 4760 على شكل حبيبات في أكياس سعة 25 كيلوغرام."
    },
    {
      "title": "التخزين والمناولة",
      "body": "يُنصح بتخزين HDCHEM 4760 بعيداً عن أشعة الشمس المباشرة والحرارة. أفضل وقت للاستخدام هو خلال 12 شهراً من تاريخ الإنتاج."
    }
  ],
  "specs": [
    {
      ...
      "testMethod": "ISO 1133",
      "unit": "g/10min",
      "typicalValue": "1.2 ± 0.5"
    },
    {
      "property": "الكثافة عند 23°C",
      "testMethod": "ISO 1183",
      "unit": "kg/m³",
      "typicalValue": "0.954 ± 0.002"
    },
    {
  ...
  "dataSheet": "/Product/Datasheet-AR/HDCHEM 4760 AR.pdf"
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'HDCHEM 4760 | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'HDCHEM 4760 هو كومباوند بلاستيكي متخصص مصمم لتطبيقات القولبة بالنفخ (Blow Molding). هذا المنتج عبارة عن مزيج من كوبوليمرات البولي إيثيلين ويتمتع بمجموعة من...'
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/products/4760` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/products/4760` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/products/4760` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/products/4760` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/products/4760` },
  ],
  script: [
