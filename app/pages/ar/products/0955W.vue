...
const PAGE_PATH = '/ar/products/0955W'
...
// ─── Product data (ROTOCHEM 0955W only) ─────────────────────────────────
const product = {
  "title": "ROTOCHEM 0955W",
  "brand": "",
  "subtitleTitle": "الوصف",
  "subtitle": "ROTOCHEM 955W هو خليط بوليمري متخصص أبيض اللون، مصمم لتطبيقات القولبة الدورانية. هذا المنتج عبارة عن مزيج من درجة كوبوليمر البولي إيثيلين متوسط الكثافة الخطي ذو توزيع ضيق للوزن الجزيئي مع ثاني أكسيد التيتانيوم (TiO₂). يُعدّ هذا الخليط الخيار الأمثل للمصنّعين الراغبين في إنتاج منتجات بخصائص ميكانيكية ممتازة وعملية إنتاج متجانسة.",
  ...
  "detailSections": [
    {
      "title": "المميزات",
      "body": "من مميزات ROTOCHEM 955W: تشتت ممتاز، ومقاومة عالية للصدمات، وجودة سطحية عالية من الداخل والخارج، ومقاومة للتشقق الناتج عن الإجهاد البيئي (ESCR)، واستقرار فعّال ضد أشعة UV."
    },
    {
      "title": "التغليف",
      "body": "يُوزَّع ROTOCHEM 955W على شكل مسحوق في أكياس سعة 20 كيلوغرام."
    },
    {
      "title": "التخزين والمناولة",
      "body": "يُنصح بتخزين ROTOCHEM 955W بعيداً عن أشعة الشمس المباشرة والحرارة. يجب أن تكون بيئة التخزين جافة وألا تتجاوز درجة الحرارة 50 درجة مئوية. أفضل وقت للاستخدام هو خلال 18 شهراً من تاريخ الإنتاج."
    }
  ],
  "specs": [
    {
      "property": "مؤشر تدفق المصهور (190°C / 2.16 kg)",
      "testMethod": "ASTM D1238-7",
      "unit": "g/10min",
      "typicalValue": "3.5 ± 0.5"
    },
    {
      "property": "الكثافة عند 23°C",
      "testMethod": "ASTM D1505-68",
      "unit": "kg/m³",
      "typicalValue": "0.937 – 0.945"
    },
    {
      "property": "نوع هيكل TiO₂",
      "testMethod": "-",
      "unit": "-",
      "typicalValue": "Rutile type"
    },
    {
      "property": "نسبة TiO₂",
      "testMethod": "-",
    ...
    {
      "property": "مقاومة الشد عند نقطة الخضوع",
      "testMethod": "ASTM D638-72",
      "unit": "MPa",
      "typicalValue": "15"
    },
    {
      "property": "نسبة الاستطالة عند الكسر",
      "testMethod": "ASTM D638",
      "unit": "%",
      "typicalValue": "> 700"
    },
    {
      "property": "معامل الانحناء",
      "testMethod": "ASTM D790",
      "unit": "MPa",
      "typicalValue": "650"
    },
    {
  ...
  "dataSheet": "/Product/Datasheet-AR/0966W AR.pdf"
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'ROTOCHEM 0955W | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'ROTOCHEM 955W هو خليط بوليمري متخصص أبيض اللون، مصمم لتطبيقات القولبة الدورانية. هذا المنتج عبارة عن مزيج من درجة كوبوليمر البولي إيثيلين متوسط الكثافة...'
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/products/0955W` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/products/0955W` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/products/0955W` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/products/0955W` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/products/0955W` },
  ],
  script: [
