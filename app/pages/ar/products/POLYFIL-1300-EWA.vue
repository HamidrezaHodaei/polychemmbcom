...
const PAGE_PATH = '/ar/products/1300EWA'
...
// ─── Product data (POLYFILL 1300 EWA only) ─────────────────────────────────
const product = {
  "title": "POLYFILL 1300 EWA",
  "brand": "",
  "subtitleTitle": "الوصف",
  "subtitle": "POLYFILL 1300 EWA مُصمَّم خصيصاً للاستخدام في تركيبات قاعدة البولي إيثيلين، ويمكن توظيفه في طيف واسع من عمليات إنتاج الأفلام والتعبئة. يمكن استخدام هذه الدرجة في إنتاج أفلام تعبئة البولي إيثيلين بنسبة استخدام تتراوح بين 5 و40 بالمئة تقريباً حسب سماكة الفيلم والمتطلبات الفنية. كما يُستخدم في إنتاج أكياس التسوق البولي إيثيلينية بنسبة معتادة بين 20 و50 بالمئة، وفي تطبيقات اللمينيشن والطلاء البولي إيثيلينية بنسبة تتراوح عادةً بين 5 و30 بالمئة.",
  "detailImage": "/Product/index/1300.webp",
  "heroImage": "/Product/index/1300.webp",
  "featureList": [],
  "detailSections": [
    {
      "title": "المميزات",
      "body": "• تقليل استهلاك الطاقة\n• تحسين التوصيل الحراري\n• تعزيز خاصية مانع الالتصاق (Anti-block)\n• تحسين جودة الطباعة على المنتج النهائي\n• زيادة سرعة الإنتاج\n• تحسين الصلابة ومعامل الشد\n• تحسين مقاومة التمزق\n• زيادة الكثافة وكفاءة الإنتاج\n• الاستعاضة الجزئية عن البوليمر وتقليل تكاليف الإنتاج\n• خفض تكاليف المواد الخام"
    },
    {
      "title": "التغليف",
      "body": "يُعرض POLYFILL 1300 EWA على شكل حبيبات قياسية في أكياس سعة 25 كيلوغرام."
    },
    {
      "title": "التخزين والنقل",
      "body": "يجب تخزين POLYFILL 1300 EWA بعيداً عن أشعة الشمس المباشرة والحرارة، في مكان جاف وبدرجة حرارة لا تتجاوز 50 درجة مئوية. قد تؤدي ظروف التخزين غير الملائمة إلى تراجع جودة المنتج وأدائه. يُنصح بتجفيفه قبل الاستخدام، ويجب استخدامه خلال 18 شهراً من تاريخ الإنتاج."
    }
  ],
  "specs": [
    {
      "property": "CaCO3",
      "testMethod": "ASTM D 4218",
      "unit": "%",
      "typicalValue": "82 ± 1"
    },
    {
      "property": "نسبة الرطوبة",
      "testMethod": "ASTM D 6980-17",
      "unit": "%",
      "typicalValue": "≤ 0.1"
    },
    {
      "property": "مؤشر تدفق المصهور (190°C / 5 kg)",
      "testMethod": "ASTM D 1238",
      "unit": "g/10min",
      "typicalValue": "3±0.5"
    },
    {
      "property": "الكثافة عند 23°C",
      "testMethod": "ASTM D 1505",
      "unit": "g/cm³",
      "typicalValue": "1.9"
    }
  ],
  "dataSheet": "/Product/Datasheet-AR/POLYFILL 1300 EWA AR.pdf"
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'POLYFILL 1300 EWA | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'POLYFILL 1300 EWA مُصمَّم خصيصاً للاستخدام في تركيبات قاعدة البولي إيثيلين، ويمكن توظيفه في طيف واسع من عمليات إنتاج الأفلام والتعبئة. يمكن استخدام هذه...'
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/products/1300EWA` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/products/1300EWA` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/products/1300EWA` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/products/1300EWA` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/products/1300EWA` },
  ],
  script: [
