...
const PAGE_PATH = '/ar/products/E178'
...
const product = {
  ...
  "brand": "",
  "subtitleTitle": "الوصف",
  "subtitle": "SLIPCHEM E 178 هو ماستر باتش انزلاقي (Slip Masterbatch) عالي الأداء يحتوي على عامل انزلاق عالي الجودة مشتت في راتنج حامل من البولي إيثيلين. مُصمَّم لتقليل معامل الاحتكاك (COF) بين طبقات أفلام البوليمر.",
  ...
  "detailSections": [
    {
      "title": "التطبيقات",
      "body": "• فيلم منفوخ (LDPE، LLDPE، HDPE)\n• أفلام (CPP، متعددة الطبقات)\n• أفلام التعبئة المغلّفة والمطبوعة\n• أفلام زراعية وأفلام تقليصية/تمددية"
    },
    {
      "title": "المميزات",
      "body": "• تفعيل سريع ومتجانس للانزلاق\n• تشتت ممتاز مع الحفاظ على شفافية الفيلم\n• عدم التداخل مع عمليات الختم أو أحبار الطباعة\n• متوافق مع معظم الأصبغة والمضافات"
    },
    {
      "title": "نسبة الاستخدام",
      "body": "من 0.5 إلى 1.5 بالمئة وزنياً. تعتمد الكمية على سماكة الفيلم والبوليمر الأساسي والقيمة المستهدفة لمعامل الاحتكاك."
    },
    {
      "title": "التغليف",
      "body": "يُعرض SLIPCHEM E 178 على شكل حبيبات قياسية في أكياس سعة 25 كيلوغرام."
    },
    {
      "title": "التخزين والمناولة",
      "body": "يُخزَّن بعيداً عن أشعة الشمس المباشرة والحرارة، في مكان جاف بدرجة حرارة لا تتجاوز 40 درجة مئوية. يُستخدم خلال 12 شهراً من تاريخ الإنتاج."
    }
  ],
  "specs": [
    {
      ...
      "testMethod": "Visual",
      "unit": "-",
      "typicalValue": "Milky-white granular pellets"
    },
    {
      "property": "نسبة المواد الفعّالة",
      "testMethod": "-",
      "unit": "wt.%",
      "typicalValue": "28 ± 1"
    },
  ...
  "dataSheet": "/Product/Datasheet-AR/SLIPCHEM E178 AR.pdf"
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'SLIPCHEM E 178 | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'SLIPCHEM E 178 هو ماستر باتش انزلاقي (Slip Masterbatch) عالي الأداء يحتوي على عامل انزلاق عالي الجودة مشتت في راتنج حامل من البولي إيثيلين. مُصمَّم لتقليل...'
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/products/E178` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/products/E178` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/products/E178` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/products/E178` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/products/E178` },
  ],
  script: [
