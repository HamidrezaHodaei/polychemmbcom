...
const PAGE_PATH = '/ar/products/110FRF'
...
// ─── Product data (CALCICHEM 110 FRF only) ─────────────────────────────────
const product = {
  "title": "CALCICHEM 110 FRF",
  "brand": "",
  "subtitleTitle": "الوصف",
  "subtitle": "CALCICHEM 110 FRF هو ماستر باتش حشو يحتوي على كربونات الكالسيوم (CaCO₃) بجسيمات ناعمة جداً ومُغلَّفة. مُصمَّم للاستخدام في إنتاج الأفلام والحبال وخيوط الرافيا والقطع المحقونة.",
  "detailImage": "/Product/index/110-1.webp",
  "heroImage": "/Product/index/110-1.webp",
  "featureList": [],
  "detailSections": [
    {
      "title": "المميزات",
      "body": "▪ زيادة سرعة الإنتاج\n▪ تقليل تكاليف المواد الخام\n▪ تقليل استهلاك الطاقة\n▪ تحسين التوصيل الحراري\n▪ تعزيز خاصية مانع الالتصاق (Anti-block)\n▪ تحسين جودة الطباعة على المنتج النهائي"
    },
    {
      "title": "التغليف",
      "body": "يُعرض CALCICHEM 110 FRF على شكل حبيبات قياسية في أكياس سعة 25 كيلوغرام."
    },
    {
      "title": "التخزين والمناولة",
      "body": "يجب تخزين CALCICHEM 110 FRF بعيداً عن أشعة الشمس المباشرة والحرارة. يُستخدم خلال 18 شهراً من تاريخ الإنتاج."
    }
  ],
  "specs": [
    {
      "property": "كربونات الكالسيوم",
      "testMethod": "-",
      "unit": "%",
      "typicalValue": "80 ± 2"
    },
    ...
    },
    {
      ...
      "testMethod": "-",
      "unit": "g/cm³",
      "typicalValue": "1.86 ± 0.05"
    }
  ],
  "dataSheet": "/Product/Datasheet-AR/110 FRF AR.pdf"
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'CALCICHEM 110 FRF | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'CALCICHEM 110 FRF هو ماستر باتش حشو يحتوي على كربونات الكالسيوم (CaCO₃) بجسيمات ناعمة جداً ومُغلَّفة. مُصمَّم للاستخدام في إنتاج الأفلام والحبال وخيوط...'
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/products/110FRF` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/products/110FRF` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/products/110FRF` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/products/110FRF` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/products/110FRF` },
  ],
  script: [
