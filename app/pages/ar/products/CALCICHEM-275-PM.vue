...
const PAGE_PATH = '/ar/products/275PM'
...
const product = {
  ...
  "brand": "",
  "subtitleTitle": "الوصف",
  "subtitle": "CALCICHEM 275 PM هو ماستر باتش حشو على قاعدة بولي بروبيلين يضمن تشتتاً وتوزيعاً ممتازين في المنتج النهائي. مُصمَّم خصيصاً للاستخدام المباشر في عملية البثق لأفلام BOPP وCPP وOPP.",
  ...
  "detailSections": [
    {
      "title": "المميزات",
      "body": "▪ تجانس وجودة ثابتة في عملية الإنتاج\n▪ مناسب لإنتاج الأفلام بسرعة عالية"
    },
    {
      "title": "التغليف",
      "body": "يُعرض CALCICHEM 275 PM على شكل حبيبات قياسية في أكياس سعة 25 كيلوغرام."
    },
    {
      "title": "التخزين والمناولة",
      "body": "يجب تخزين CALCICHEM 275 PM بعيداً عن أشعة الشمس المباشرة والحرارة. يُستخدم خلال 18 شهراً من تاريخ الإنتاج."
    }
  ],
  "specs": [
    {
    ...
    {
      "property": "متوسط حجم الجسيمات (d50%)",
      "testMethod": "-",
      "unit": "μm",
      "typicalValue": "≤ 2"
    },
  ...
  "dataSheet": "/Product/Datasheet-AR/275PM AR.pdf"
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'CALCICHEM 275 PM | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'CALCICHEM 275 PM هو ماستر باتش حشو على قاعدة بولي بروبيلين يضمن تشتتاً وتوزيعاً ممتازين في المنتج النهائي. مُصمَّم خصيصاً للاستخدام المباشر في عملية البثق...'
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/products/275PM` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/products/275PM` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/products/275PM` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/products/275PM` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/products/275PM` },
  ],
  script: [
