<template>
  <div dir="" style="font-family: 'Tajawal', -apple-system, BlinkMacSystemFont, sans-serif;">
    <navbar />
    <div class="min-h-screen bg-[#f1f2f2] py-16 px-4 relative" dir="rtl">
      ...
      <div class="relative flex justify-center items-center w-full" style="height: 480px; min-height: 340px;">
        ...
        >
          <h1 class="text-6xl font-bold text-[#848484] mb-0 text-center select-none" style="text-shadow: 0 2px 16px #fff, 0 1px 0 #fff; font-family: 'Tajawal', -apple-system, BlinkMacSystemFont, sans-serif;">
            اتصل بنا
          </h1>
        </div>
      </div>
      ...
      >
        <h2 class="text-4xl font-bold text-[#848484] mb-8 relative z-20">الشرق الأوسط</h2>
        <div class="flex overflow-x-auto gap-0 no-scrollbar">
          ...
          >
            ...
            <div class="space-y-2 w-full flex flex-col items-center">
              <p class="text-sm text-[#848484]">البريد الإلكتروني</p>
              <div class="flex items-center justify-center gap-2">
                ...
                >
                  <span v-if="copiedIdx === countryRefsOffset + idx && copied">تم النسخ!</span>
      ...
      >
        <h2 class="text-4xl font-bold text-[#848484] mb-8 ">الدول المستقلة والقوقاز</h2>
        <div class="flex overflow-x-auto gap-0 no-scrollbar">
          <div
          ...
          >
            ...
            <div class="space-y-2 w-full flex flex-col items-center">
              ...
              >
                <span v-if="copiedIdx === cisRefsOffset + idx && copied">تم النسخ!</span>
                <span v-else>نسخ</span>
              </button>
            </div>
            <div
      ...
      <div
        ...
        class="max-w-7xl mx-auto mb-12"
      >
        <h2 class="text-4xl font-bold text-[#848484] mb-8 text">أوروبا</h2>
        <div class="flex overflow-x-auto gap-0 no-scrollbar">
          <div
          ...
          >
            ...
            <div class="space-y-2 w-full flex flex-col items-center">
              ...
              <div class="flex items-center justify-center gap-2">
                ...
                >
                  <span v-if="copiedIdx === europeRefsOffset + idx && copied">تم النسخ!</span>
                  <span v-else>نسخ</span>
                </button>
              </div>
            </div>
      ...
      <div
        ...
        class="max-w-7xl mx-auto mb-12"
      >
        <h2 class="text-4xl font-bold text-[#848484] mb-8 ">آسيا والمحيط الهادئ</h2>
        <div class="flex overflow-x-auto gap-0 no-scrollbar">
          <div
          ...
          >
            ...
            <div class="space-y-2 w-full flex flex-col items-center">
              ...
              <div class="flex items-center justify-center gap-2">
                ...
                >
                  <span v-if="copiedIdx === asiaRefsOffset + idx && copied">تم النسخ!</span>
                  <span v-else>نسخ</span>
                </button>
              </div>
            </div>
...
>
  <h2 class="text-4xl font-bold text-[#848484] mb-8">عنواننا</h2>
  <div class="bg-white rounded-lg shadow-lg p-8">
    <div class="flex flex-col lg:flex-row gap-8 items-start">
      <!-- Address Information -->
      <div class="flex-1 space-y-6" dir="rtl">
        <div>
          <h3 class="text-2xl font-semibold text-[#848484] mb-4">منطقة آراس الحرة</h3>
          <p class="text-[#848484] leading-relaxed">
            قطعة 437 و 438، شارع الجنوب C<br />
            حي الصناعة المرحلة 2<br />
            منطقة آراس الحرة والصناعية
          </p>
        </div>

        <div>
          <h4 class="text-lg font-semibold text-[#848484] mb-2">معلومات الاتصال</h4>
          <div class="space-y-2">
            <p class="text-[#848484]">
        ...
        <div>
          <h4 class="text-lg font-semibold text-[#848484] mb-2">ساعات العمل</h4>
          <p class="text-[#848484]">
            <span class="font-medium w-16">السبت – الأربعاء:</span><br>
            08:00 – 17:00 (توقيت طهران، UTC+3:30)<br><br>
            <span class="font-medium w-16">الخميس – الجمعة:</span><br>
            08:00 – 16:00 (توقيت طهران، UTC+3:30)
          </p>
        </div>

        <div>
          <h4 class="text-lg font-semibold text-[#848484] mb-2">معلومات الاتصال بقسم المبيعات</h4>
          <div class="space-y-2">
            <p class="text-[#848484]">
              <span class="font-medium inline-block w-16">البريد:</span> 
              <a href="mailto:Sales@polychemmb.com" class="text-[#848484] hover:text-[#FFD700] transition-colors">
                Sales@polychemmb.com
              </a>
            </p>
            <p class="text-[#848484]">
              <span class="font-medium inline-block w-16">الهاتف:</span> 
...
import FormComponent from '~/components/ar/contact/form.vue'
import MapComponent from '~/components/ar/contact/map.vue'
import navbar from '~/components/ar/layout/navbar.vue'
import footer2 from '~/components/ar/layout/footer.vue'
import worldc from '~/components/ar/contact/world.vue'
import Chatbox from '~/components/ar/chatbox/chatbox.vue'

// Tabs
const tabs = [
  { key: 'middleEast', label: 'الشرق الأوسط' },
  { key: 'cis', label: 'الدول المستقلة والقوقاز' },
  { key: 'europe', label: 'أوروبا' },
  { key: 'asia', label: 'آسيا' },
  { key: 'address', label: 'عنواننا' },
  { key: 'form', label: 'أرسل لنا رسالة' }
]
