    ...
    <div class="card relative h-[490px] w-full max-w-[900px] mx-auto bg-white shadow-[10px_10px_93px_0px_rgba(0,0,0,0.75)]">
      ...
      <div class="right ml-[590px] mr-5">
        <h1 class="pt-[15px] text-[1.2rem] text-[#FFCD05] font-bold">
          POLYCHEM في معرض تبريز البلاستيك 2025
        </h1>
        ...
        <!-- Description -->
        <p class="pt-2.5  text-[0.95rem] leading-[150%] text-black">شاركت POLYCHEM في المعرض الدولي المتخصص الثاني والعشرين للمطاط والبلاستيك والآلات (معرض تبريز البلاستيك 2025)
         <br> معلومات الكشك:
<br> المكان: مركز تبريز الدولي للمعارض
<br> القاعة: شهريار
<br> رقم الكشك: 21
<br>
        </p>
        ...
        <!-- Read More Button -->
        <NuxtLink to="/ar/news" class="btn-slide-down inline-block px-5 py-3 mt-[80px] uppercase tracking-wider text-sm text-[#FFCD05] border-3 border-[#FFCD05] rounded-lg relative overflow-hidden cursor-pointer">
