...
const PAGE_PATH = '/tr/products/CALCICHEM-126-FP'
...
const product = {
  ...
  subtitle: `CALCICHEM 126 FP, %80 kalsiyum karbonat (CaCO₃) içeren polipropilen bazlı bir dolgu masterbatch'idir. Poliolefin işleme sırasında doğrudan ekleme için tasarlanmıştır (ekstrüzyon ve enjeksiyon kalıplama).`,
  detailImage: '/Product/index/calcum-126.webp',
  heroImage: '/Product/index/calcum-126.webp',
  featureList: ['Poliolefin ekstrüzyon ve enjeksiyon kalıplama', 'Genel amaçlı dolgu uygulamaları'],
  detailSections: [
    { title: 'AVANTAJ', body: `▪️ Verim artışı
▪️ Düşük su taşıma
▪️ Isı iletkenliği artışı
▪️ Anti-bloklama etkisi
▪️ Son üründe baskı iyileştirmesi` },
    { title: 'AMBALAJ', body: `25 kg'lık standart peletler halinde temin edilir.` },
    { title: 'DEPOLAMA VE KULLANIM', body: `≤50°C'de kuru, doğrudan güneş ışığından uzak saklayın. Üretim tarihinden itibaren 18 ay içinde işleyin.` }
  ],
  specs: [
    { property: 'Taşıyıcı', testMethod: '-', unit: '-', typicalValue: 'Polipropilen' },
    { property: 'CaCO₃ içeriği', testMethod: 'ASTM D4218', unit: '%', typicalValue: '80 ± 2' },
    { property: 'Nem içeriği', testMethod: 'ASTM D6980-17', unit: 'ppm', typicalValue: '≤ 1500' },
    { property: 'Melt Index (2.16 kg / 230°C)', testMethod: 'ASTM D1238', unit: 'g/10dk', typicalValue: '6 ± 2' },
    { property: 'Yoğunluk @ 23°C', testMethod: 'ASTM D1505', unit: 'g/cm³', typicalValue: '1.85 ± 0.05' }
  ],
  dataSheet: '/Product/Datasheet-TR/126 FP TR.pdf',
  msds: '/CALCICHEM 126 FP MSDS TR.pdf',
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'CALCICHEM 126 FP – Polipropilen Dolgu Masterbatch | POLYCHEM'
const pageDescription = 'CALCICHEM 126 FP, %80 kalsiyum karbonat içeren polipropilen bazlı dolgu masterbatch\'idir; verim ve kalite artışı sağlar.'
