...
const PAGE_PATH = '/tr/products/SlIPCHEM-E-178'
...
const product = {
  ...
  subtitle: `SlIPCHEM E 178, yüksek kaliteli kaydırma ajanı içeren yüksek performanslı bir slip masterbatch'tir. Polimer film katmanları arasındaki sürtünmeyi azaltmak için geliştirilmiştir.`,
  detailImage: '/Product/index/slipchem.webp',
  heroImage: '/Product/index/slipchem.webp',
  featureList: ['Şişirme ve cast polietilen filmler', 'Lamineli ve baskılı ambalaj filmleri'],
  detailSections: [
    { title: 'TIPIK UYGULAMALAR', body: `• Şişirme filmi (LDPE, LLDPE, HDPE)
• Cast film (CPP, PE bazlı çok katmanlı)
• Lamineli ve baskılı ambalaj filmleri
• Tarım filmleri ve shrink/stretch filmler` },
    { title: 'AVANTAJ', body: `• Hızlı ve uniform slip aktivasyonu
• Tutarlı COF azaltımı
• Mükemmel dağılım ve film berraklığı
• Mühürleme veya baskı mürekkeplerine müdahale etmez
• Çoğu pigment ve katkı ile uyumlu` },
    { title: 'EKLEME ORANI', body: `• %0.5 – 1.5 (toplam film formülasyonuna göre)` },
    { title: 'AMBALAJ', body: `SlIPCHEM E 178, 25 kg'lık standart peletler halinde temin edilir.` },
    { title: 'DEPOLAMA VE KULLANIM', body: `Kuru, ≤40°C, doğrudan güneş ışığından uzak saklayın. Teslimattan itibaren 12 ay içinde işleyin.` }
  ],
  specs: [
    { property: 'Görünüm', testMethod: 'Visual', unit: '-', typicalValue: 'Süt beyazı granül peletler' },
    { property: 'Aktif içerik', testMethod: '-', unit: 'wt.%', typicalValue: '28 ± 1' },
    { property: 'Taşıyıcı Reçine', testMethod: '-', unit: '–', typicalValue: 'LDPE / LLDPE uyumlu' },
    { property: 'MFI (190°C / 2.16 kg)', testMethod: 'ASTM D1238', unit: 'g/10dk', typicalValue: '12 ± 1' },
    { property: 'Yoğunluk', testMethod: 'ASTM D792', unit: 'g/cm³', typicalValue: '0.94 – 0.96' },
    { property: 'Nem içeriği', testMethod: 'ASTM D6980-17', unit: 'wt.%', typicalValue: '< 0.2' }
  ],
  dataSheet: '/Product/Datasheet-TR/SLIPCHEM E178 TR.pdf',
  msds: '/SLIPCHEM E178 MSDS TR.pdf',
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'SlIPCHEM E 178 – Kaydırıcı (Slip) Masterbatch | POLYCHEM'
const pageDescription = 'SlIPCHEM E 178, film katmanları arasındaki sürtünmeyi azaltan yüksek performanslı slip masterbatch\'tir.'
