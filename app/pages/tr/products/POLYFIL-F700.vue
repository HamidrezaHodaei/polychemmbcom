...
const PAGE_PATH = '/tr/products/POLYFIL-F700'
...
const product = {
  ...
  subtitle: `POLYFIL F700, HDPE ekstrüzyon filmleri için üstün mekanik özelliklere ve mükemmel film homojenliğine sahip yüksek performanslı bir polietilen bileşiğidir. 10–25 mikron kalınlığında filmler için önerilir; alışveriş torbaları, T-shirt torbaları, çöp torbaları ve gıda teması için filmler.`,
  detailImage: '/Product/index/polyfilf700-2.webp',
  heroImage: '/Product/index/polyfilf700-2.webp',
  featureList: ['Alışveriş torbaları ve tişört torbaları', 'Gıda ile temas eden filmler ve çöp torbaları'],
  detailSections: [
    { title: 'AVANTAJ', body: `Yüksek çekme dayanımı, düşük jel içeriği, mükemmel nem bariyeri, gıda ile temas uygunluğu, yüksek sertlik, UV direnci ve üstün işlenebilirlik.` },
    { title: 'AMBALAJ', body: `POLYFIL F700, 25 kg'lık torbalarda toz formunda temin edilir.` },
    { title: 'DEPOLAMA VE KULLANIM', body: `Doğrudan güneş ışığından uzak, kuru bir ortamda ≤50°C'de saklayın. Teslimattan itibaren 12 ay içinde işleyin.` }
  ],
  specs: [
    { property: 'MFI (190°C / 5 kg)', testMethod: 'ISO 1133', unit: 'g/10dk', typicalValue: '0.19 ± 0.1' },
    { property: 'Yoğunluk', testMethod: 'ISO 1183', unit: 'kg/m³', typicalValue: '0.952 ± 0.003' },
    { property: 'Nem İçeriği', testMethod: 'ASTM D6980-17', unit: 'ppm', typicalValue: '≤ 1500' },
    { property: 'Çekme Dayanımı @ Akma (MD)', testMethod: 'ASTM D638', unit: 'MPa', typicalValue: '24' },
    { property: 'Kopma Uzaması (MD, TD)', testMethod: 'ASTM D638', unit: '%', typicalValue: '450, 240' },
    { property: 'ESCR (IGEPAL 10%) (F50, 50°C)', testMethod: 'ASTM D1693', unit: 'HR', typicalValue: '> 1000' }
  ],
  dataSheet: '/Product/Datasheet-TR/POLYFIL F700  TR.pdf',
  msds: '/POLYFIL F700 MSDS TR.pdf',
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'POLYFIL F700 – HDPE Şişirme Film Bileşiği | POLYCHEM'
const pageDescription = 'POLYFIL F700, HDPE ekstrüzyon filmleri için yüksek performanslı polietilen bileşiğidir; alışveriş torbası, tişört torbası ve gıda teması için uygundur.'
