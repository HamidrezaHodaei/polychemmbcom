...
const PAGE_PATH = '/tr/products/0955W'
...
const product = {
  ...
  subtitle: `ROTOCHEM 0955W, rotasyon kalıplama uygulamaları için tasarlanmış özel beyaz renkli bir plastik bileşiktir. Dar moleküler ağırlık dağılımına sahip lineer orta yoğunluklu polietilen kopolimer ile TiO2 içerir ve çeşitli avantajlı özelliklere sahiptir. ROTOCHEM, zorlu çevresel koşullara dayanabilecek güvenilir ve dayanıklı bir malzeme arayan üreticiler için ideal bir seçimdir.`,
  detailImage: '/Product/index/955w-p.jpg',
  heroImage: '/Product/index/955w-p.jpg',
  featureList: ['Su tankları ve depolama kapları', 'Rotasyon kalıplama ürünleri'],
  detailSections: [
    { title: 'AVANTAJ', body: `Mükemmel dağılım, olağanüstü darbe dayanımı, üstün iç ve dış yüzey kalitesi, optimal beyazlık ve etkili UV stabilizasyonu.` },
    { title: 'AMBALAJ', body: `Rotochem, 20 kg'lık torbalarda toz formunda temin edilir.` },
    { title: 'DEPOLAMA VE KULLANIM', body: `Doğrudan güneş ışığından uzak, kuru bir ortamda ≤50°C'de saklayın. Teslimattan itibaren 18 ay içinde işleyin.` }
  ],
  specs: [
    { property: 'MFI (190°C / 2.16 kg)', testMethod: 'ASTM D1238-7', unit: 'g/10dk', typicalValue: '3.5 ± 0.5' },
    { property: 'Yoğunluk', testMethod: 'ASTM D1505-68', unit: 'kg/m³', typicalValue: '0.937 – 0.945' },
    { property: 'TiO₂ içeriği', testMethod: '-', unit: '%', typicalValue: '2' },
    { property: 'Nem içeriği', testMethod: 'ASTM D6980-17', unit: 'ppm', typicalValue: '≤ 1500' },
    { property: 'Çekme dayanımı @ akma', testMethod: 'ASTM D638', unit: 'MPa', typicalValue: '15' },
    { property: 'Kopma uzaması', testMethod: 'ASTM D638', unit: '%', typicalValue: '> 700' }
  ],
  dataSheet: '/Product/Datasheet-TR/0955W TR.pdf',
  msds: '/0955W MSDS TR.pdf',
}
...
const specs = ref([
  ...
  { id: 'advantage', title: 'AVANTAJ', content: product.detailSections[0].body, open: true },
  { id: 'packaging', title: 'AMBALAJ', content: product.detailSections[1].body, open: true },
  { id: 'storage_and_handling', title: 'DEPOLAMA VE KULLANIM', content: product.detailSections[2].body, open: true },
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'ROTOCHEM 0955W – Beyaz Rotasyon Kalıplama Bileşiği | POLYCHEM'
const pageDescription = 'ROTOCHEM 0955W, rotasyon kalıplama için tasarlanmış beyaz lineer orta yoğunluklu polietilen bileşiğidir; mükemmel dağılım, darbe dayanımı ve UV kararlılığı sunar.'
