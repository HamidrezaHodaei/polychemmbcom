...
const PAGE_PATH = '/tr/products/HDCHEM-4760'
...
const product = {
  ...
  subtitle: `HDCHEM 4760, şişirme kalıplama uygulamaları için tasarlanmış özel bir plastik bileşiktir. Polietilen kopolimerlerinden oluşur ve çeşitli avantajlı özelliklere sahiptir.`,
  detailImage: '/Product/index/Hdchem-2.webp',
  heroImage: '/Product/index/Hdchem-2.webp',
  featureList: ['Şişirme kalıplama ile üretilen kaplar', 'Katı ambalaj uygulamaları'],
  detailSections: [
    { title: 'AVANTAJ', body: `İyi akışkanlık, darbe dayanımı, ESCR ve rijidite gibi avantajlı özelliklere sahiptir.` },
    { title: 'AMBALAJ', body: `HDCHEM 4760, 25 kg'lık torbalarda toz formunda temin edilir.` },
    { title: 'DEPOLAMA VE KULLANIM', body: `Doğrudan güneş ışığından ve ısıdan uzak, kuru bir yerde saklayın. ≤50°C. Teslimattan itibaren 12 ay içinde işleyin.` }
  ],
  specs: [
    { property: 'MFI (190°C / 5 kg)', testMethod: 'ISO 1133', unit: 'g/10dk', typicalValue: '1.2 ± 0.5' },
    { property: 'Yoğunluk', testMethod: 'ISO 1183', unit: 'kg/m³', typicalValue: '0.954 ± 0.002' },
    { property: 'Nem içeriği', testMethod: 'ASTM D6980-17', unit: 'ppm', typicalValue: '≤ 1500' },
    { property: 'Vicat yumuşama noktası', testMethod: 'ASTM D1525', unit: '°C', typicalValue: '115' },
    { property: 'Darbe dayanımı (23°C)', testMethod: 'ISO 179/1eA', unit: 'mJ/mm²', typicalValue: '9' },
    { property: 'Sertlik', testMethod: 'ASTM D2240', unit: 'Shore D', typicalValue: '62' },
    { property: 'Şişme oranı', testMethod: '-', unit: '%', typicalValue: '120' }
  ],
  dataSheet: '/Product/Datasheet-TR/HDCHEM 4760 TR.pdf',
  msds: '/HDCHEM 4760 MSDS TR.pdf',
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'HDCHEM 4760 – Şişirme Kalıplama Bileşiği | POLYCHEM'
const pageDescription = 'HDCHEM 4760, iyi akışkanlık, darbe dayanımı, rijitlik ve ESCR performansı sunan şişirme kalıplama bileşiğidir.'
