...
const PAGE_PATH = '/tr/products/POLYFIL-1300-EWA'
...
const product = {
  ...
  subtitle: `POLYFILL 1300 EWA, %82 kalsiyum karbonat (CaCO₃) içeren polietilen bazlı bir dolgu masterbatch'idir. Yüksek kaliteli ve çok ince işlenmiş CaCO₃ içeriği sayesinde mükemmel dağılım sağlar. Doğrudan poliolefin işleminde (ekstrüzyon ve enjeksiyon kalıplama) kullanıma uygundur.`,
  detailImage: '/Product/index/1300.webp',
  heroImage: '/Product/index/1300.webp',
  featureList: ['Polietilen ambalaj filmleri ve torbaları', 'Polietilen laminasyon ve kaplama'],
  detailSections: [
    { title: 'AVANTAJ', body: `• Sertlik ve çekme modülünü artırır
• Yırtılma direncini artırır
• Çekme dayanımını artırır/korur
• Yoğunluk ve verimi artırır
• Yüksek ısı dayanımı
• Anti-blok etkisi sağlar` },
    { title: 'AMBALAJ', body: `POLYFILL 1300 EWA, 25 kg'lık standart peletler halinde temin edilir.` },
    { title: 'DEPOLAMA VE KULLANIM', body: `Doğrudan güneş ışığı ve ısıdan uzak kuru bir yerde saklayın. 30°C'yi geçmemelidir. Kötü depolama kaliteyi düşürebilir. Kullanım öncesi kurutun ve üretim tarihinden itibaren 6 ay içinde işleyin.` }
  ],
  specs: [
    { property: 'Mineral içeriği', testMethod: 'ASTM D 4218', unit: '%', typicalValue: '82 ± 1' },
    { property: 'Yoğunluk', testMethod: 'ASTM D 1505', unit: 'g/cm³', typicalValue: '1.9' },
    { property: 'Nem içeriği', testMethod: 'ASTM D6980-17', unit: '%', typicalValue: '≤ 0.1' },
    { property: 'MFI (190 °C / 5 Kg)', testMethod: 'ASTM D1238', unit: 'g/10dk', typicalValue: '3±0.5' }
  ],
  dataSheet: '/Product/Datasheet-TR/POLYFILL 1300 EWA TR.pdf',
  msds: '/POLYFILL 1300 EWA MSDS TR.pdf',
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'POLYFILL 1300 EWA – Kalsiyum Karbonat Dolgu Masterbatch | POLYCHEM'
const pageDescription = 'POLYFILL 1300 EWA, %82 CaCO₃ içeren polietilen bazlı dolgu masterbatch\'idir; sertlik, verim ve maliyet avantajı sağlar.'
