  ...
  <div v-if="isMobile" class="page-wrap">
    ...
    <div class="content-below-navbar">
      ...
      <div class="bg-[#A8A8A8] text-white px-5 py-8">
        <h3 class="font-semibold tracking-widest text-lg mb-6 text-[#FFCD05]">TEKNİK ÖZELLİKLER</h3>
        <div class="space-y-3">
          <div
      ...
      <div class="px-5 py-6 bg-page-bg">
        <div class="cta-stack-mobile">
          <div class="cta-pair-mobile">
            ...
            >
              <span>Veri Sayfasını İndir</span>
            </a>
          </div>
        </div>
      </div>
    ...
    <div class="shell">
      <header class="header">
        <nav class="nav">
          ...
          <a class="nav-item effect-1-yellow" href="#" title="Ürünler" @click.prevent="goToProducts">
            <span class="btn-text">Ürünler</span>
      ...
      <main class="main-grid">
        ...
        <div class="right-col">
          ...
          <div class="cta-row">
            ...
            >
              <span>VERİ SAYFASINI İNDİR</span>
            </a>
          </div>
        </div>
...
const PAGE_PATH = '/tr/products/UVCHEM-MB-R18'
...
const product = {
  title: 'UVCHEM MB R18',
  brand: '',
  subtitleTitle: 'AÇIKLAMA',
  subtitle: `UVCHEM MB R18, yüksek performanslı UV stabilizatör masterbatch'idir. Rafya ve dokuma kumaş uygulamaları için tasarlanmıştır. Uzun süreli foto-oksidasyona karşı Hindered Amine Light Stabilizers (HALS) ve UV absorbanları içerir.`,
  detailImage: '/Product/index/Uv-chem.webp',
  heroImage: '/Product/index/Uv-chem.webp',
  featureList: ['Polipropilen rafya bantları ve dokuma çuvallar', 'Açık alan depolama ve inşaat kumaşları'],
  detailSections: [
    { title: 'TIPIK UYGULAMALAR', body: `• Polipropilen rafya bantları ve dokuma çuvallar
• Tarım ve endüstriyel ambalaj kumaşları
• PP monofilament ve ipler
• Açık alan depolama ve inşaat kumaşları` },
    { title: 'AVANTAJ', body: `• Uzun süreli UV direnci ve renk stabilitesi
• Açık alanda çekme ve uzama özelliklerini korur
• Düşük volatilite ve slip/antiblock katkılarına müdahale etmez` },
    { title: 'EKLEME ORANI', body: `Polipropilen baz reçineye %1.0 UVCHEM MB R18 ekleyin. Açık alan uygulamaları için %1.5–2.0'a kadar artırılabilir.` },
    { title: 'AMBALAJ', body: `25 kg'lık standart peletler halinde temin edilir.` },
    { title: 'DEPOLAMA VE KULLANIM', body: `≤40°C'de kuru, doğrudan güneş ışığından uzak saklayın. Teslimattan itibaren 12 ay içinde işleyin.` }
  ],
  specs: [
    { property: 'Görünüm', testMethod: 'Visual', unit: '–', typicalValue: 'Krem-beyaz ila açık bej' },
    { property: 'Aktif içerik', testMethod: '-', unit: 'wt.%', typicalValue: '20 ± 2' },
    { property: 'MFI (230°C / 2.16 kg)', testMethod: 'ASTM D1238', unit: 'g/10dk', typicalValue: '7 – 9' },
    { property: 'Yoğunluk', testMethod: 'ASTM D792', unit: 'g/cm³', typicalValue: '0.91' },
    { property: 'Uçucu madde (2 h @ 220°C)', testMethod: 'TGA', unit: 'wt.%', typicalValue: '< 1' },
    { property: 'Termal stabilite (5% ağırlık kaybı)', testMethod: 'TGA', unit: '°C', typicalValue: '> 280' },
    { property: 'UV koruma verimliliği', testMethod: 'ASTM D4329', unit: '-', typicalValue: '500 saat QUV sonrası %90\'dan fazla çekme dayanımı' }
  ],
  dataSheet: '/Product/Datasheet-TR/UVChem MB-R18 TR.pdf',
  msds: '/UVChem MB-R18 MSDS TR.pdf',
}

// ─── Desktop accordion specs (same content as product.specs / sections) ──
const specs = ref([
  { id: 'description', title: 'AÇIKLAMA', content: product.subtitle, open: true },
  { id: 'typical_applications', title: 'TIPIK UYGULAMALAR', content: product.detailSections[0].body, open: true },
  { id: 'advantage', title: 'AVANTAJ', content: product.detailSections[1].body, open: true },
  { id: 'addition_rate', title: 'EKLEME ORANI', content: product.detailSections[2].body, open: true },
  { id: 'packaging', title: 'AMBALAJ', content: product.detailSections[3].body, open: true },
  { id: 'storage_and_handling', title: 'DEPOLAMA VE KULLANIM', content: product.detailSections[4].body, open: true },
  { id: 'techspecs', title: 'TEKNİK ÖZELLİKLER', isTable: true, open: true },
])
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'UVCHEM MB R18 – UV Stabilizatör Masterbatch | POLYCHEM'
const pageDescription = 'UVCHEM MB R18, rafya ve dokuma kumaşlar için HALS ve UV absorbanları içeren yüksek performanslı UV stabilizatör masterbatch\'idir.'
...
const breadcrumbJsonLd = computed(() => ({
  ...
  '@type': 'BreadcrumbList',
  itemListElement: [
    { '@type': 'ListItem', position: 1, name: 'Anasayfa', item: `${SITE_URL}/tr` },
    { '@type': 'ListItem', position: 2, name: 'Ürünler', item: `${SITE_URL}/tr/products` },
