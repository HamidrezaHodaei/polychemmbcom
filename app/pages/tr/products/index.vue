  ...
  <div class="page">
    <div class="wrap">
      ...
      <div class="header-row">
        <h1 class="sr-only">PolyChem Masterbatch ve Bileşik Ürünleri</h1>
      </div>
      <div class="toolbar">
        <div class="tabs">
          <button
        ...
        <div class="search-box">
          ...
          />
          <button class="search-go" @click="searchQuery = searchQuery">ARA</button>
        </div>
      </div>
      ...
      <div class="grid">
        <div v-for="item in filteredItems" :key="item.id" class="card">
          ...
          <div class="bottom">
            <a :href="`/tr/products/${productFileMap[item.name] || item.name}`" class="view-btn">
...
const tabs = ['Tümü', 'Dolgu Masterbatch', 'Renk Masterbatch', 'Katkı Masterbatch', 'Bileşik']
...
const items = ref([
  {
    id: 1,
    name: 'ROTOCHEM 0955W',
    description: 'Rotasyon kalıplama için özel beyaz bileşik; güçlü UV kararlılığı ve tutarlı yüzey kalitesi sunar.',
    category: 'Bileşik',
  ...
  },
  {
    id: 2,
    name: 'ROTOCHEM 0955B',
    description: 'Dayanıklı, parlak ve darbeye dayanıklı parçalar için tasarlanmış mavi rotasyon kalıplama bileşiği.',
    category: 'Bileşik',
  ...
  },
  {
    id: 3,
    name: 'POLYFIL F700',
    description: 'HDPE şişirme film uygulamaları için mükemmel homojenliğe sahip yüksek performanslı polietilen bileşiği.',
    category: 'Bileşik',
  ...
  },
  {
    id: 4,
    name: 'SLIPCHEM E 178',
    description: 'Film sarma, torba üretimi ve ambalaj proseslerinde sürtünmeyi azaltan kaydırıcı (slip) masterbatch.',
    category: 'Katkı Masterbatch',
  ...
  },
  {
    ...
    description: 'PE uygulamalarında sertlik, verim ve yoğunluğu artıran kalsiyum karbonat dolgu masterbatch\'i.',
    category: 'Dolgu Masterbatch',
  ...
  },
  {
    id: 6,
    name: 'HDCHEM 4760',
    description: 'İyi akışkanlık, darbe dayanımı, rijitlik ve ESCR performansı sunan şişirme kalıplama bileşiği.',
    category: 'Bileşik',
  ...
  },
  {
    id: 7,
    name: 'RAFCOLOR 1560',
    description: 'Rafya, bant ve dokuma ürünler için mükemmel dağılıma sahip yüksek konsantrasyonlu beyaz masterbatch.',
    category: 'Renk Masterbatch',
  ...
  },
  {
    ...
    description: 'Verimlilik ve kalite için yüksek kalsiyum karbonat oranına sahip polipropilen bazlı dolgu masterbatch\'i.',
    category: 'Dolgu Masterbatch',
  ...
  },
  {
    ...
    description: 'Film, rafya ve halatlar için mükemmel maliyet-performans dengesine sahip mineral katkı maddesi.',
    category: 'Dolgu Masterbatch',
  ...
  },
  {
    ...
    description: 'BOPP, CPP ve OPP film ekstrüzyonu için özel olarak formüle edilmiş yüksek performanslı mineral masterbatch.',
    category: 'Dolgu Masterbatch',
  ...
  },
  {
    id: 11,
    name: 'UVCHEM MB R18',
    description: 'Polipropilen ürünlerde açık hava dayanıklılığını ve renk kararlılığını artıran UV stabilizatör masterbatch.',
    category: 'Katkı Masterbatch',
...
useSeoMeta({
  title: 'Ürünler | POLYCHEM',
  description:
    "PolyChem'in dolgu, renk ve katkı masterbatch'leri ile polimer bileşiklerini keşfedin — ROTOCHEM, POLYFIL, CALCICHEM ve UVCHEM ürün gruplarını inceleyin.",
  ogTitle: 'Masterbatch ve Bileşik Ürünleri | PolyChem',
  ogDescription:
    "PolyChem'in dolgu, renk ve katkı masterbatch'leri ile polimer bileşiklerini keşfedin.",
  ogType: 'website',
  ogUrl: 'https://polychemmb.com/tr/products',
  ogImage: 'https://polychemmb.com/Polychem-1.png',
  twitterCard: 'summary_large_image',
  twitterTitle: 'Masterbatch ve Bileşik Ürünleri | PolyChem',
  twitterDescription:
    "PolyChem'in dolgu, renk ve katkı masterbatch'leri ile polimer bileşiklerini keşfedin.",
...
useHead({
  link: [
    ...
    { rel: 'canonical', href: 'https://polychemmb.com/tr/products' },
      ...
      innerHTML: JSON.stringify({
        ...
        itemListElement: items.value.map((item, index) => ({
          ...
          item: {
            ...
            url: `https://polychemmb.com/tr/products/${productFileMap[item.name] || item.name}`,
          },
        })),
      }),
    },
