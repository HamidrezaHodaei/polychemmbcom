...
const PAGE_PATH = '/tr/products/CALCICHEM-110-FRF'
...
const product = {
  ...
  subtitle: `CALCICHEM 110 FRF, yüksek, çok ince işlenmiş CaCO₃ içeren mineral bir katkı maddesidir. Film, rafya ve ipler için tasarlanmıştır ve ayrıca PE ve PP taşıyıcılı genel amaçlı ürünler için uygundur.`,
  detailImage: '/Product/index/110-1.webp',
  heroImage: '/Product/index/110-1.webp',
  featureList: ['Filmler, rafya ve halatlar', 'Genel amaçlı PE/PP ürünleri'],
  detailSections: [
    { title: 'AVANTAJ', body: `▪️ Verim artışı
▪️ Hammadde maliyetlerinde azalma
▪️ Isı iletkenliği artışı
▪️ Güç tüketiminde azalma
▪️ Son üründe baskı iyileştirmesi` },
  ...
  specs: [
    { property: 'Taşıyıcı', testMethod: '-', unit: '-', typicalValue: 'Poliolefin' },
    { property: 'CaCO₃ içeriği', testMethod: '-', unit: '%', typicalValue: '80 ± 2' },
    { property: 'Nem içeriği', testMethod: 'ASTM D6980-17', unit: 'ppm', typicalValue: '≤ 1500' },
    { property: 'Melt Index (230°C / 2.16 kg)', testMethod: '-', unit: 'g/10dk', typicalValue: '1.5 ± 1' },
    { property: 'Yoğunluk @ 23°C', testMethod: '-', unit: 'g/cm³', typicalValue: '1.86 ± 0.05' }
  ],
  dataSheet: '/Product/Datasheet-TR/110 FRF TR.pdf',
  msds: '/CALCICHEM 110 FRF MSDS TR.pdf',
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'CALCICHEM 110 FRF – Mineral Katkı Maddesi | POLYCHEM'
const pageDescription = 'CALCICHEM 110 FRF, film, rafya ve halatlar için tasarlanmış çok ince CaCO₃ içeren mineral katkı maddesidir.'
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/product-110frf` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/product-110frf` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/product-110frf` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/product-110frf` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/product-110frf` },
  ],
  script: [
