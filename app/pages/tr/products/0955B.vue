...
const PAGE_PATH = '/tr/products/0955B'
...
const product = {
  ...
  subtitle: `Rotochem 0955B, rotasyon kalıplama uygulamaları için tasarlanmış özel mavi renkli bir plastik bileşiktir. Dar moleküler ağırlık dağılımına sahip lineer orta yoğunluklu polietilen kopolimer ile TiO2 içerir ve çeşitli avantajlı özelliklere sahiptir.`,
  ...
  specs: [
    ...
    { property: 'Pigment içeriği', testMethod: '-', unit: '%', typicalValue: '0.3 – 0.5' },
  ...
  dataSheet: '/Product/Datasheet-TR/0966B TR.pdf',
  msds: '/0955B MSDS TR.pdf',
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'ROTOCHEM 0955B – Mavi Rotasyon Kalıplama Bileşiği | POLYCHEM'
const pageDescription = 'ROTOCHEM 0955B, rotasyon kalıplama için tasarlanmış mavi lineer orta yoğunluklu polietilen bileşiğidir; mükemmel dağılım, darbe dayanımı ve UV kararlılığı sunar.'
