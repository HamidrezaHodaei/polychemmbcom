...
const PAGE_PATH = '/tr/products/RAFCOLOR-1560'
...
const product = {
  ...
  subtitle: `RAFCOLOR, yüksek oranda titanyum dioksit ve termoplastik polipropilen reçinesi içeren beyaz masterbatch'tir. Yüksek konsantrasyonlu, mükemmel dağılım ve termal stabilite sağlar. Rafya, bant, CF/BCF iplik ve diğer ürünler için önerilir.`,
  detailImage: '/Product/index/Rafcolor-1.webp',
  heroImage: '/Product/index/Rafcolor-1.webp',
  featureList: ['Rafya bantları ve dokuma çuvallar', 'CF/BCF iplik üretimi'],
  detailSections: [
    { title: 'AVANTAJ', body: `Mükemmel dağılım, yüksek uyumluluk, iyi işlenebilirlik, düşük su alımı ve stabil özellikler sunar.` },
    { title: 'AMBALAJ', body: `25 kg'lık standart peletler halinde temin edilir.` },
    { title: 'DEPOLAMA VE KULLANIM', body: `≤50°C'de kuru, doğrudan güneş ışığından uzak saklayın. Teslimattan itibaren 18 ay içinde işleyin.` }
  ],
  specs: [
    { property: 'Titanyum kristal tipi', testMethod: '-', unit: '-', typicalValue: 'Rutile tipi' },
    { property: 'Katı madde içeriği', testMethod: '-', unit: '%', typicalValue: '60 ± 2' },
    { property: 'Nem içeriği', testMethod: 'ASTM D6980-17', unit: '%', typicalValue: '< 0.2' },
    { property: 'MFI (230°C / 2.16 kg)', testMethod: 'ASTM D1238', unit: 'g/10dk', typicalValue: '12 ± 2' },
    { property: 'Yoğunluk', testMethod: 'ASTM D1505', unit: 'g/cm³', typicalValue: '1.8' }
  ],
  dataSheet: '/Product/Datasheet-TR/RAFCOLOR 1560 TR.pdf',
  msds: '/RAFCOLOR 1560 MSDS TR.pdf',
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'RAFCOLOR 1560 – Beyaz Masterbatch | POLYCHEM'
const pageDescription = 'RAFCOLOR 1560, yüksek oranda titanyum dioksit içeren beyaz masterbatch\'tir; rafya, bant ve CF/BCF iplik için önerilir.'
