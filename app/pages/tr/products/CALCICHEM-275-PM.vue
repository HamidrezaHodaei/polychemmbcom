...
const PAGE_PATH = '/tr/products/CALCICHEM-275-PM'
...
const product = {
  ...
  subtitle: `CALCICHEM 275 PM, %75 ultra ince mineral dolgu içeren polipropilen bazlı bir mineral masterbatch'tir. BOPP, CPP ve OPP film ekstrüzyonunda doğrudan ekleme için formüle edilmiştir.`,
  detailImage: '/Product/index/275-1.webp',
  heroImage: '/Product/index/275-1.webp',
  featureList: ['BOPP, CPP ve OPP film ekstrüzyonu', 'Yüksek performanslı film uygulamaları'],
  detailSections: [
    { title: 'AVANTAJ', body: `▪️ Ürün tutarlılığı ve kalite artışı
▪️ İşleme stabilitesinde iyileşme
▪️ Yüksek performanslı film uygulamalarına uygun` },
    { title: 'AMBALAJ', body: `25 kg'lık standart peletler halinde temin edilir.` },
    { title: 'DEPOLAMA VE KULLANIM', body: `≤35°C'de kuru, doğrudan güneş ışığından uzak saklayın. Üretim tarihinden itibaren 18 ay içinde işleyin.` }
  ],
  specs: [
    { property: 'Taşıyıcı', testMethod: '-', unit: '-', typicalValue: 'Polipropilen' },
    { property: 'Mineral içeriği', testMethod: '-', unit: '%', typicalValue: '75 ± 1' },
    { property: 'Ortalama parçacık boyutu (d50%)', testMethod: '-', unit: 'μm', typicalValue: '≤ 2' },
    { property: 'Nem içeriği', testMethod: 'ASTM D6980-17', unit: 'ppm', typicalValue: '≤ 1500' },
    { property: 'Melt Index (230°C / 2.16 kg)', testMethod: '-', unit: 'g/10dk', typicalValue: '3 ± 1' },
    { property: 'Yoğunluk @ 23°C', testMethod: '-', unit: 'g/cm³', typicalValue: '1.75 ± 0.05' }
  ],
  dataSheet: '/Product/Datasheet-TR/275 PM TR.pdf',
  msds: '/CALCICHEM 275 PM MSDS TR.pdf',
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'CALCICHEM 275 PM – BOPP/CPP/OPP Film Masterbatch | POLYCHEM'
const pageDescription = 'CALCICHEM 275 PM, BOPP, CPP ve OPP film ekstrüzyonu için formüle edilmiş yüksek performanslı mineral masterbatch\'tir.'
