...
const PAGE_PATH = '/en/products/0955B'
...
const product = {
  ...
  subtitle: "Rotochem 0955B is a specialized blue color plastic compound designed for rotational molding applications. It is a compound of linear medium density polyethylene copolymer grade with a narrow molecular weight distribution with Tio2 that possesses a range of beneficial characteristics.",
  ...
  {
    "title": "ADVANTAGE",
    "body": "Excellent dispersion, exceptional impact strength, superior internal and external surface finish, optimal whiteness, and efficient UV stabilization."
  },
  {
    "title": "PACKAGING",
  ...
  },
  {
    ...
    "body": "Store in dry condition at ≤50°C away from direct sunlight. Process within 18 months after delivery."
  }
],
  specs: [
  {
    "property": "MFI (190°C / 2.16 kg)",
  ...
  {
    "property": "Elongation @ break",
    "testMethod": "ASTM D638",
    "unit": "%",
    "typicalValue": "> 700"
  }
],
  dataSheet: "/0955B EN.pdf",
  msds: "/0955B MSDS EN.pdf",
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'ROTOCHEM 0955B – Blue Rotational Molding Compound | POLYCHEM'
const pageDescription = 'ROTOCHEM 0955B is a blue linear medium density polyethylene compound engineered for rotational molding, offering excellent dispersion, impact strength and UV stability.'
