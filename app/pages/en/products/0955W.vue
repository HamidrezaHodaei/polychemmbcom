    ...
    <div class="shell">
      ...
      <main class="main-grid">
        ...
        <div class="right-col">
          ...
          <p class="desc">
            ROTOCHEM 0955W is a specialized white color plastic compound designed
            for rotational molding applications. It is a compound of linear medium
            density polyethylene copolymer grade with a narrow molecular weight
            distribution with Tio2 that possesses a range of beneficial
            characteristics. ROTOCHEM is an ideal choice for manufacturers who
            require a reliable and durable material that can withstand harsh
            environmental conditions. Whether utilized in industrial or consumer
            applications, this plastic material is a suitable choice for those
            seeking consistent and stable materials.
          </p>

          <ul class="feature-list">
            <li>Water tanks and storage containers</li>
            <li>Rotational molding products</li>
          </ul>
...
const PAGE_PATH = '/en/products/0955W'
...
const product = {
  ...
  featureList: ['Water tanks and storage containers', 'Rotational molding products'],
  detailSections: [
    { title: 'ADVANTAGE', body: `Excellent dispersion, exceptional impact strength, superior internal and external surface finish, optimal whiteness, and efficient UV stabilization.` },
    { title: 'PACKAGING', body: `Rotochem is supplied in powder form packed in 20 kg bags.` },
    { title: 'STORAGE AND HANDLING', body: `Store in dry condition at ≤50°C away from direct sunlight. Process within 18 months after delivery.` },
  ],
  specs: [
    ...
    { property: 'Moisture content', testMethod: 'ASTM D6980-17', unit: 'ppm', typicalValue: '≤ 1500' },
    { property: 'Tensile strength @ yield', testMethod: 'ASTM D638', unit: 'MPa', typicalValue: '15' },
    { property: 'Elongation @ break', testMethod: 'ASTM D638', unit: '%', typicalValue: '> 700' }
  ],
  dataSheet: '/0955W EN.pdf',
  msds: '/0955W MSDS EN.pdf',
}
...
const specs = ref([
  ...
  { id: 'storage', title: 'STORAGE AND HANDLING', content: product.detailSections[2].body, open: true },
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'ROTOCHEM 0955W – White Rotational Molding Compound | POLYCHEM'
const pageDescription = 'ROTOCHEM 0955W is a white linear medium density polyethylene rotational molding compound engineered for durable tanks, storage containers and molded parts.'
