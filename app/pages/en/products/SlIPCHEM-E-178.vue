...
const PAGE_PATH = '/en/products/SlIPCHEM-E-178'
...
const product = {
  ...
  subtitle: "SLIPCHEM E 178 is a high-performance slip masterbatch containing high quality slip agent dispersed in a polyethylene carrier resin. It is specifically developed to reduce the coefficient of friction (COF) between polymer film layers during winding, bag-making, and packaging processes.",
  detailImage: '/Product/index/slipchem.webp',
  heroImage: '/Product/index/slipchem.webp',
  featureList: ["Blown & cast PE film", "Laminated and printed packaging films"],
  detailSections: [
  {
  ...
  },
  {
    ...
    "body": "0.5 – 1.5 wt.% (based on total film formulation)"
  },
  {
    "title": "PACKAGING",
  ...
  },
  {
    ...
    "body": "Store dry, ≤40°C, away from direct sunlight. Process within 12 months."
  }
],
  specs: [
  {
  ...
  {
    "property": "Carrier Resin",
    "testMethod": "-",
    "unit": "–",
    "typicalValue": "LDPE / LLDPE compatible"
  },
  {
  ...
  dataSheet: "/SLIPCHEM E178 EN.pdf",
  msds: "/SLIPCHEM E178 MSDS EN.pdf",
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'SLIPCHEM E 178 – Slip Masterbatch for Films | POLYCHEM'
const pageDescription = 'SLIPCHEM E 178 is a high-performance slip masterbatch that reduces coefficient of friction in PE films for winding, bag-making and packaging processes.'
