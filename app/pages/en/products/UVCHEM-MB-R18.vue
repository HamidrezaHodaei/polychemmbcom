...
const PAGE_PATH = '/en/products/UVCHEM-MB-R18'
...
const product = {
  ...
  subtitle: "UVCHEM MB R18 is a high-performance UV stabilizer masterbatch, designed for use in raffia and woven fabric applications. Contains a synergistic blend of Hindered Amine Light Stabilizers (HALS) and UV absorbers optimized for long-term resistance against photo-oxidation.",
  detailImage: '/Product/index/Uv-chem.webp',
  heroImage: '/Product/index/Uv-chem.webp',
  featureList: ["PP raffia tapes and woven sacks", "Outdoor storage and construction fabrics"],
  detailSections: [
  {
  ...
  },
  {
    ...
    "body": "Add 1.0 wt.% UVCHEM MB R18 to the polypropylene base resin. For outdoor applications, dosage can be increased up to 1.5–2.0 wt.%."
  },
  {
    "title": "PACKAGING",
  ...
  },
  {
    ...
    "body": "Store ≤40°C, dry, away from direct sunlight. Process within 12 months."
  }
],
  specs: [
  {
  ...
  {
    "property": "Active Content",
    "testMethod": "-",
    "unit": "wt.%",
    "typicalValue": "20 ± 2"
  },
  {
    "property": "Melt Flow Index (230 °C / 2.16 kg)",
  ...
  {
    "property": "Volatile Matter (2 h @ 220 °C)",
    "testMethod": "TGA",
    "unit": "wt.%",
    "typicalValue": "< 1"
  },
  {
    "property": "Thermal Stability (5% weight loss)",
    "testMethod": "TGA",
    "unit": "°C",
    "typicalValue": "> 280"
  },
  {
    "property": "UV protection efficiency",
  ...
  msds: "/UVChem MB-R18 MSDS EN.pdf",
}

// ─── Desktop accordion specs (same content as product.specs / sections) ──
const specs = ref([
  { id: "typical_applications", title: "TYPICAL APPLICATIONS", content: product.detailSections[0].body, open: true },
  { id: "advantage", title: "ADVANTAGE", content: product.detailSections[1].body, open: true },
  { id: "typical_addition_rate", title: "TYPICAL ADDITION RATE", content: product.detailSections[2].body, open: true },
  { id: "packaging", title: "PACKAGING", content: product.detailSections[3].body, open: true },
  { id: "storage_and_handling", title: "STORAGE AND HANDLING", content: product.detailSections[4].body, open: true },
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'UVCHEM MB R18 – UV Stabilizer Masterbatch | POLYCHEM'
const pageDescription = 'UVCHEM MB R18 is a HALS-based UV stabilizer masterbatch for PP raffia and woven fabrics, delivering long-term photo-oxidation resistance for outdoor use.'
