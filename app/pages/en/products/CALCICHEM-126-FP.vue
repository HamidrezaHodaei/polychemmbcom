...
const PAGE_PATH = '/en/products/CALCICHEM-126-FP'
...
const product = {
  ...
  subtitle: "CALCICHEM 126 FP is a polypropylene-based filler masterbatch containing 80% calcium carbonate (CaCO₃). Specifically designed for direct addition during the processing of polyolefins, including extrusion and injection molding.",
  detailImage: '/Product/index/calcum-126.webp',
  heroImage: '/Product/index/calcum-126.webp',
  featureList: ["Polyolefin extrusion & injection molding", "General-purpose filler applications"],
  detailSections: [
  {
    "title": "ADVANTAGE",
  ...
  },
  {
    ...
    "body": "Store ≤50°C, dry, away from direct sunlight. Process within 18 months after production date."
  }
],
  specs: [
  {
  ...
  {
    "property": "CaCO₃ content",
    "testMethod": "ASTM D4218",
    "unit": "%",
    "typicalValue": "80 ± 2"
  },
  {
  ...
  {
    "property": "Melt Index (2.16 kg / 230°C)",
  ...
  },
  {
    ...
    "unit": "g/cm³",
    "typicalValue": "1.85 ± 0.05"
  }
],
  dataSheet: "/CALCICHEM 126 FP.pdf",
  msds: "/CALCICHEM 126 FP MSDS EN.pdf",
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'CALCICHEM 126 FP – PP Filler Masterbatch | POLYCHEM'
const pageDescription = 'CALCICHEM 126 FP is a polypropylene-based filler masterbatch with 80% calcium carbonate, improving productivity, thermal conductivity and print quality.'
