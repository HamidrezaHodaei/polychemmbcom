<!-- /pages/en/product-rafcolor-1560.vue -->
<template>
  <!-- ===================================================================== -->
  <!-- MOBILE LAYOUT                                                          -->
  <!-- ===================================================================== -->
...
const PAGE_PATH = '/en/products/RafCOLOR-1560'
...
const product = {
  ...
  subtitle: "RAFCOLOR is the white masterbatch that consists of a high proportion of rutile titanium dioxide and thermoplastic polypropylene resin. Highly-concentrated white MB with excellent dispersion and thermal stability. Recommended for raffia, Tapes, CF/BCF yarn, and other products.",
  detailImage: '/Product/index/Rafcolor-1.webp',
  heroImage: '/Product/index/Rafcolor-1.webp',
  featureList: ["Raffia tapes and woven sacks", "CF/BCF yarn production"],
  detailSections: [
  {
    "title": "ADVANTAGE",
  ...
  },
  {
    ...
    "body": "Store ≤50°C, dry, away from direct sunlight. Process within 18 months after delivery."
  }
],
  specs: [
  {
    "property": "Titanium crystal type",
    "testMethod": "-",
    "unit": "-",
  ...
  dataSheet: "/RAFCOLOR 1560 EN.pdf",
  msds: "/RAFCOLOR 1560 MSDS EN.pdf",
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'RAFCOLOR 1560 – White Masterbatch| POLYCHEM'
const pageDescription = 'RAFCOLOR 1560 is a highly-concentrated rutile TiO2 white masterbatch in polypropylene, recommended for raffia, tapes and CF/BCF yarn with excellent dispersion.'
