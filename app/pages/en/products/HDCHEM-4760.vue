...
const PAGE_PATH = '/en/products/HDCHEM-4760'
...
const product = {
  ...
  subtitle: "HDCHEM 4760 is a specialized plastic compound designed for blow molding applications. It is a compound of polyethylene copolymers that possesses a range of beneficial characteristics.",
  detailImage: '/Product/index/Hdchem-2.webp',
  heroImage: '/Product/index/Hdchem-2.webp',
  featureList: ["Blow molded containers", "Rigid packaging applications"],
  detailSections: [
  {
    "title": "ADVANTAGE",
  ...
  },
  {
    ...
    "body": "HDCHEM 4760 should be stored to prevent direct sunlight and/or heat exposure. The storage area should also be dry and preferably not exceed 50°C. It is advisable to process HDCHEM 4760 within 12 months after delivery."
  }
],
  specs: [
  {
  ...
  {
    "property": "Swell ratio",
    "testMethod": "-",
    "unit": "%",
    "typicalValue": "120"
  }
],
  dataSheet: "/HDCHEM 4760 EN.pdf",
  msds: "/HDCHEM 4760 MSDS EN.pdf",
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'HDCHEM 4760 – HDPE Blow Molding Compound | POLYCHEM'
const pageDescription = 'HDCHEM 4760 is a polyethylene copolymer compound for blow molding applications, offering good flowability, impact strength, ESCR and rigidity.'
