...
const PAGE_PATH = '/en/products/POLYFIL-1300-EWA'
...
const product = {
  ...
  subtitle: "POLYFILL 1300 EWA is a Poly Ethylene-based filler masterbatch containing 82% calcium carbonate (CaCO₃). The POLYFILL 1300 EWA features a high, very fine, treated CaCO₃ content, ensuring excellent dispersion within the final product. It is specifically designed for direct addition during the processing of polyolefins, including extrusion and injection molding. POLYFILL 1300 EWA making it suitable for a PE Packaging Film, PE Shopping Bags, PE Laminating & Coating. The POLYFILL 1300 EWA is manufactured using the premium additives and advanced production lines.",
  detailImage: '/Product/index/1300.webp',
  heroImage: '/Product/index/1300.webp',
  featureList: ["PE packaging film and shopping bags", "PE laminating & coating"],
  detailSections: [
  {
    "title": "ADVANTAGE",
    "body": "Improve Stiffness and Tensile Modulus\nImprove Tear Resistance\nIncrease/Keep Tensile Strength\nIncrease Density & Output\nHigh Heat Resistance\nAct as Anti-Block"
  },
  {
    "title": "PACKAGING",
    "body": "POLYFILL 1300 EWA is supplied in standard pellet form packed in 25 kg bags."
  },
  {
    "title": "STORAGE AND HANDLING",
    "body": "POLYFILL 1300 EWA should be stored to prevent direct sunlight and heat exposure. The storage area should also be dry and preferably not exceed 30°C; Bad storage conditions may lead to quality deterioration and product performance. It is advisable to pre-dry before use and process within 6 months after production date."
  }
],
  specs: [
  {
  ...
  {
    "property": "Melt Flow Index (MFI) (190 °C/5 Kg)",
    "testMethod": "ASTM D1238",
    "unit": "g/10min",
    "typicalValue": "3±0.5"
  }
],
  dataSheet: "/POLYFILL 1300 EWA EN.pdf",
  msds: "/POLYFILL 1300 EWA MSDS EN.pdf",
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'POLYFILL 1300 EWA – CaCO₃ Filler Masterbatch | POLYCHEM'
const pageDescription = 'POLYFILL 1300 EWA is a PE-based filler masterbatch with 82% calcium carbonate for packaging film, shopping bags and lamination, improving stiffness and output.'
