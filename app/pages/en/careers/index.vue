...
useSeoMeta({
  title: 'Careers | POLYCHEM',
  description: 'Apply for open positions at POLYCHEM. Discover exciting career opportunities in advanced polymer compounds, engineering masterbatches, and chemical technologies.',
  ogTitle: 'Careers | Join Our Team at POLYCHEM',
  ogDescription: 'Explore job opportunities and advance your career with POLYCHEM, a leading specialist in polymer production.',
  ogUrl: 'https://polychemmb.com/en/careers',
  ogType: 'website',
})
</script>
