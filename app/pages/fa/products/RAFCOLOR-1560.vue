<!-- /pages/fa/product-rafcolor-1560.vue -->
<template>
  <!-- ===================================================================== -->
  <!-- MOBILE LAYOUT                                                          -->
  <!-- ===================================================================== -->
...
const PAGE_PATH = '/fa/products/RafCOLOR-1560'
...
// ─── Product data (RAFCOLOR 1560 only) ─────────────────────────────────
const product = {
  title: 'RAFCOLOR 1560',
  brand: '',
  subtitleTitle: 'توضیحات',
  subtitle: `RAFCOLOR 1560 یک مستربچ سفید بر پایه پلی‌پروپیلن و درصد بالائی از تیتانیوم دی‌اکساید می باشد. این مستربچ با پراکندگی و پایداری حرارتی بسیار خوب، برای تولید محصولات متنوع قابل استفاده است.`,
  detailImage: '/Product/index/Rafcolor-1.webp',
  heroImage: '/Product/index/Rafcolor-1.webp',
  featureList: ['نوارهای رافیا و کیسه‌های بافته‌شده', 'تولید نخ CF/BCF'],
  detailSections: [
    { title: 'مزایا', body: `RAFCOLOR 1560 دارای ویژگی‌هایی از جمله: پراکندگی عالی، پوشش‌دهی بالا، فرآیندپذیری خوب، جذب آب پایین و خواص پایدار می‌باشد.` },
    { title: 'بسته‌بندی', body: `مستربچ سفید RAFCOLOR 1560 به‌صورت گرانول در کیسه‌های ۲۵ کیلوگرمی عرضه می‌شود.` },
    { title: 'نگهداری و جابجایی', body: `توصیه می شود RAFCOLOR 1560 به دور از تابش مستقیم نور خورشید و گرما نگهداری شود. بهترین زمان استفاده حداکثر تا ۱۸ ماه پس از تاریخ تولید می باشد.` }
  ],
  specs: [
    { property: 'درصد مواد معدنی', testMethod: '-', unit: '%', typicalValue: '60 ± 2' },
    { property: 'میزان رطوبت', testMethod: 'ASTM D6980-17', unit: '%', typicalValue: '< 0.2' },
    { property: '(230 ºC/2.16 Kg) شاخص جریان مذاب', testMethod: 'ASTM D1238', unit: 'g/10min', typicalValue: '12 ± 2' },
    { property: '23 ˚C چگالی در', testMethod: 'ASTM D1505', unit: 'g/cm³', typicalValue: '1.8' }
  ],
  dataSheet: '/Product/Datasheet-Fa/RAFCOLOR 1560 Fa.pdf',
  msds: '/RAFCOLOR 1560 MSDS Fa.pdf',
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'RAFCOLOR 1560 – مستربچ سفید | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'RAFCOLOR 1560 مستربچ سفید بر پایه پلی‌پروپیلن با درصد بالای تیتانیوم دی‌اکساید، برای رافیا، نوار و نخ CF/BCF با پراکندگی عالی.'
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/product-rafcolor-1560` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/product-rafcolor-1560` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/product-rafcolor-1560` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/product-rafcolor-1560` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/product-rafcolor-1560` },
  ],
  script: [
