...
const PAGE_PATH = '/fa/products/SlIPCHEM-E-178'
...
// ─── Product data (SLIPCHEM E 178 only) ─────────────────────────────────
const product = {
  title: 'SLIPCHEM E 178',
  brand: '',
  subtitleTitle: 'توضیحات',
  subtitle: `SLIPCHEM E 178 یک مستربچ لیزکننده (Slip masterbatch) با عملکرد بالا است که حاوی عامل لغزنده با کیفیت بالا است که در رزین حامل پلی‌اتیلن پراکنده شده است. برای کاهش ضریب اصطکاک (COF) بین لایه‌های فیلم پلیمری طراحی شده است.`,
  detailImage: '/Product/index/slipchem.webp',
  heroImage: '/Product/index/slipchem.webp',
  featureList: ['فیلم‌های دمشی و کستِ پلی‌اتیلن', 'فیلم‌های بسته‌بندی لمینت و چاپ‌شده'],
  detailSections: [
    { title: 'کاربرد', body: `• فیلم دمشی (LDPE، LLDPE، HDPE)
• فیلم (CPP، چندلایه)
• فیلم‌های بسته‌بندی لمینت‌شده و چاپ‌شده
• فیلم‌های کشاورزی و فیلم‌های شرینک/استرچ` },
    { title: 'مزایا', body: `• فعال‌سازی لغزندگی سریع و یکنواخت
• پراکندگی عالی و حفظ شفافیت فیلم
• عدم تداخل با عملیات آب‌بندی یا جوهرهای چاپ
• سازگار با اکثر رنگدانه‌ها و افزودنی‌ها` },
    { title: 'درصد مصرف', body: `میزان ۰٫۵ تا ۱٫۵ درصد وزنی. مقدار مصرف وابسته به ضخامت فیلم، پلیمر پایه و مقدار ضریب اصطکاک نهایی مورد نظر می باشد.` },
    { title: 'بسته‌بندی', body: `SLIPCHEM E 178 به صورت گرانول استاندارد در کیسه‌های ۲۵ کیلوگرمی عرضه می‌شود.` },
    { title: 'نگهداری و جابجایی', body: `دور از تابش مستقیم نور خورشید و گرما، در محل خشک با دمای زیر ۴۰ درجه سانتی‌گراد نگهداری شود. حداکثر تا ۱۲ ماه پس از تولید استفاده گردد.` }
  ],
  specs: [
    { property: 'مشخصات ظاهری', testMethod: 'Visual', unit: '-', typicalValue: 'Milky-white granular pellets' },
    { property: 'درصد مواد فعال', testMethod: '-', unit: 'wt.%', typicalValue: '28 ± 1' },
    { property: '(2.16kg / 230°C) شاخص جریان مذاب', testMethod: 'ASTM D1238', unit: 'g/10 min', typicalValue: '12 ± 1' },
    { property: '23 ˚C چگالی در', testMethod: 'ASTM D792', unit: 'g/cm³', typicalValue: '0.94 – 0.96' },
    { property: 'میزان رطوبت', testMethod: 'ASTM D6980-17', unit: 'wt.%', typicalValue: '< 0.2' }
  ],
  dataSheet: '/Product/Datasheet-Fa/SLIPCHEM E178 Fa.pdf',
  msds: '/SLIPCHEM E178 MSDS Fa.pdf',
}

// ─── Desktop accordion specs (same content as product.specs / sections) ──
const specs = ref([
  { id: 'typical_applications', title: 'کاربرد', content: product.detailSections[0].body, open: true },
  { id: 'advantage', title: 'مزایا', content: product.detailSections[1].body, open: true },
  { id: 'typical_addition_rate', title: 'درصد مصرف', content: product.detailSections[2].body, open: true },
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'SLIPCHEM E 178 – مستربچ لیزکننده فیلم | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'SLIPCHEM E 178 مستربچ لیزکننده با عملکرد بالا برای کاهش ضریب اصطکاک بین لایه‌های فیلم پلی‌اتیلن در فرآیندهای پیچش، تولید کیسه و بسته‌بندی.'
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/product-e178` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/product-e178` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/product-e178` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/product-e178` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/product-e178` },
  ],
  script: [
