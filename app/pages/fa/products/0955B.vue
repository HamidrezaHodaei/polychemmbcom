...
const PAGE_PATH = '/fa/products/0955B'
...
// ─── Product data (ROTOCHEM 0955B only) ─────────────────────────────────
const product = {
  title: 'ROTOCHEM 0955B',
  brand: '',
  subtitleTitle: 'توضیحات',
  subtitle: `ROTOCHEM 955B یک آمیزه پلیمری تخصصی آبی رنگ است که برای کاربرد قالب‌گیری دورانی طراحی شده است. این محصول ترکیبی از گرید کوپلیمر پلی‌اتیلن با چگالی متوسط خطی با توزیع وزن مولکولی باریک و رنگدانه آبی می‌باشد.`,
  detailImage: '/Product/index/955B.webp',
  heroImage: '/Product/index/955B.webp',
  featureList: ['مخازن آب و ظروف نگهداری', 'محصولات قالب‌گیری دورانی'],
  detailSections: [
    { title: 'مزایا', body: `از ویژگی‌های ROTOCHEM 955B می توان به پراکندگی عالی، استحکام ضربه‌ای فوق‌العاده، کیفیت سطحی بالا در داخل و خارج محصول، مقاومت در برابر ترک‌خوردگی ناشی از تنش محیطی (ESCR) و پایداری مؤثر در برابر اشعه UV اشاره نمود.` },
    { title: 'بسته‌بندی', body: `ROTOCHEM 955B به صورت پودر و در کیسه‌های ۲۰ کیلوگرمی ارسال می گردد.` },
    { title: 'نگهداری و جابجایی', body: `توصیه می شود ROTOCHEM 955B به دور از تابش مستقیم نور خورشید و گرما نگهداری شود. محیط نگهداری باید خشک بوده و دمای آن ترجیحاً از ۵۰ درجه سانتی‌گراد تجاوز نکند. بهترین زمان استفاده از ROTOCHEM 955B حداکثر تا ۱۸ ماه پس از تاریخ تولید می باشد.` }
  ],
  specs: [
    ...
    { property: 'میزان خاکستر', testMethod: '-', unit: '%', typicalValue: '0.3 – 0.5' },
  ...
  dataSheet: '/Product/Datasheet-Fa/ROTOCHEM 955B Fa.pdf',
}
...
const specs = ref([
  ...
  { id: 'storage_and_handling', title: 'نگهداری و جابجایی', content: product.detailSections[2].body, open: true },
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'ROTOCHEM 0955B – آمیزه پلیمری آبی رنگ قالب‌گیری دورانی | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'ROTOCHEM 0955B آمیزه‌ای پلیمری آبی رنگ بر پایه کوپلیمر پلی‌اتیلن با چگالی متوسط خطی برای قالب‌گیری دورانی، با پراکندگی عالی و پایداری در برابر اشعه UV.'
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/product-955b` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/product-955b` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/product-955b` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/product-955b` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/product-955b` },
  ],
  script: [
