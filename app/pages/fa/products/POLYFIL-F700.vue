...
const PAGE_PATH = '/fa/products/POLYFIL-F700'
...
// ─── Product data (POLYFIL F700 only) ─────────────────────────────────
const product = {
  title: 'POLYFIL F700',
  brand: '',
  subtitleTitle: 'توضیحات',
  subtitle: `POLYFIL F700 یک کامپاند پلی‌اتیلن است که به‌طور ویژه برای کاربردهای فیلم دمشی پلی‌اتیلن سنگین (HDPE Blown Film) فرموله شده است. این گرید به‌گونه‌ای طراحی شده که خواص مکانیکی مطلوب، یکنواختی عالی فیلم و فرآیندپذیری مناسب را حتی در تولید فیلم‌های بسیار نازک فراهم می‌کند.`,
  detailImage: '/Product/index/polyfilf700-2.webp',
  heroImage: '/Product/index/polyfilf700-2.webp',
  featureList: ['کیسه‌های خرید و کیسه‌های تی‌شرتی', 'فیلم‌های تماس با مواد غذایی و زباله'],
  detailSections: [
    { title: 'مزایا', body: `• استحکام کششی بالا همراه با مقاومت مناسب در برابر ضربه
• میزان ژل پایین جهت تولید فیلم‌های صاف و بدون عیب
• سختی بالا که موجب پایداری ابعادی مناسب محصول می‌شود
• دامنه دمای کاری گسترده و مقاومت در برابر اشعه UV
• فرآیندپذیری عالی روی خطوط استاندارد تولید فیلم HDPE` },
    { title: 'راهنمای فرآیند تولید', body: `دمای ذوب: ۱۹۰-۲۱۰ درجه سانتی‌گراد
نسبت Blow Up Ratio: سه الی پنج
Frost Line Height: هشت الی ده برابر قطر قالب` },
    { title: 'بسته‌بندی', body: `POLYFIL F700 به‌صورت گرانول و در کیسه‌های ۲۵ کیلوگرمی عرضه می‌شود.` },
    { title: 'نگهداری و جابجایی', body: `توصیه می شود POLYFIL F700 به دور از تابش مستقیم نور خورشید و گرما نگهداری شود. بهترین زمان استفاده حداکثر تا ۱۲ ماه پس از تاریخ تولید می باشد.` }
  ],
  specs: [
    { property: '(190°C / 5 kg) شاخص جریان مذاب', testMethod: 'ISO 1133', unit: 'g/10min', typicalValue: '0.19 ± 0.1' },
    { property: '23 ˚C چگالی در', testMethod: 'ISO 1183', unit: 'kg/m³', typicalValue: '0.952 ± 0.003' },
    { property: 'میزان رطوبت', testMethod: 'ASTM D6980-17', unit: 'ppm', typicalValue: '≤ 1500' },
    { property: 'نقطه ذوب', testMethod: 'ASTM D2117', unit: '°C', typicalValue: '135 ± 5' },
    { property: '(Vicat) نقطه نرمی', testMethod: 'ASTM D1525', unit: '°C', typicalValue: '124' },
    { property: 'استحکام کششی در نقطه تسلیم (MD)', testMethod: 'ASTM D638', unit: 'MPa', typicalValue: '24' },
    { property: 'درصد افزایش طول در نقطه شکست (MD, TD)', testMethod: 'ASTM D638', unit: '%', typicalValue: '450, 240' },
    { property: 'مقاومت در برابر ترک خوردگی تنشی محیطی', testMethod: 'ASTM D1693', unit: 'HR', typicalValue: '> 1000' }
  ],
  dataSheet: '/Product/Datasheet-Fa/POLYFIL F700 Fa.pdf',
  msds: '/POLYFIL F700 MSDS Fa.pdf',
}
...
const specs = ref([
  ...
  { id: 'process_guide', title: 'راهنمای فرآیند تولید', content: product.detailSections[1].body, open: true },
  { id: 'packaging', title: 'بسته‌بندی', content: product.detailSections[2].body, open: true },
  { id: 'storage_and_handling', title: 'نگهداری و جابجایی', content: product.detailSections[3].body, open: true },
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'POLYFIL F700 – کامپاند فیلم دمشی HDPE | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'POLYFIL F700 کامپاند پلی‌اتیلن سنگین برای فیلم دمشی، مناسب کیسه خرید، کیسه تی‌شرتی و فیلم‌های تماس با مواد غذایی، با استحکام کششی بالا و یکنواختی عالی.'
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/product-f700` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/product-f700` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/product-f700` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/product-f700` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/product-f700` },
  ],
  script: [
