...
const PAGE_PATH = '/fa/products/UVCHEM-MB-R18'
...
// ─── Product data (UVCHEM MB R18 only) ─────────────────────────────────
const product = {
  title: 'UVCHEM MB R18',
  brand: '',
  subtitleTitle: 'توضیحات',
  subtitle: `UVCHEM MB-R18 یک مستربچ پایدارکننده اشعه فرابنفش (UV) با عملکرد بالا است که برای استفاده در رافیا و پارچه‌های بافته شده طراحی شده است. این محصول شامل ترکیبی هم‌افزا از پایدارکننده‌های نوری آمینی (HALS) و جاذب‌های اشعه فرابنفش (UV) است.`,
  detailImage: '/Product/index/Uv-chem.webp',
  heroImage: '/Product/index/Uv-chem.webp',
  featureList: ['نوارها و کیسه‌های بافته‌شده رافیا پلی‌پروپیلن', 'پارچه‌های نگهداری در فضای باز و ساختمانی'],
  detailSections: [
    { title: 'کاربردهای متداول', body: `• نوارها و کیسه‌های بافته شده پلی‌پروپیلن رافیا
• فیلم‌های بسته‌بندی کشاورزی و صنعتی
• مونوفیلامنت‌ها و طناب‌های PP` },
    { title: 'مزایا', body: `• مقاومت عالی در برابر اشعه فرابنفش (UV) و پایداری رنگ بلندمدت
• حفظ خواص کششی و طولی در طول قرارگیری در معرض نور مستقیم خورشید
• سازگاری بسیار خوب با PP
• گرانول‌های بدون گرد و روان برای تغذیه یکنواخت و پایدار` },
    { title: 'میزان افزودن معمول', body: `برای دستیابی به حفاظت بهینه توصیه می‌شود ۱٪ وزنی UVCHEM MB-R18 در طول فرآیند اکستروژن اضافه شود. برای فضای باز با تابش بالا، دوز می‌تواند تا ۱٫۵–۲٪ وزنی افزایش یابد.` },
    { title: 'بسته‌بندی', body: `UVCHEM MB-R18 به‌صورت گرانول در کیسه‌های ۲۵ کیلوگرمی عرضه می‌شود.` },
    { title: 'نگهداری و جابجایی', body: `UVCHEM MB-R18 باید در محلی ذخیره شود که از تابش مستقیم نور خورشید و گرما محافظت شود. دمای محل ذخیره‌سازی از ۴۰ درجه سانتی‌گراد تجاوز نکند. حداکثر تا ۱۲ ماه پس از تولید استفاده گردد.` }
  ],
  specs: [
    { property: 'مشخصات ظاهری', testMethod: 'Visual', unit: '–', typicalValue: 'Off-white to light beige' },
    { property: '(2.16kg / 230°C) شاخص جریان مذاب', testMethod: 'ASTM D1238', unit: 'g/10 min', typicalValue: '7 – 9' },
    { property: '23 ˚C چگالی در', testMethod: 'ASTM D792', unit: 'g/cm³', typicalValue: '0.91' },
    { property: 'درصد مواد فرار (2 h @ 220 °C)', testMethod: 'TGA', unit: 'wt.%', typicalValue: '< 1' },
    { property: 'پایداری حرارتی (5% weight loss)', testMethod: 'TGA', unit: '°C', typicalValue: '> 280' },
    { property: 'حفاظت در برابر اشعه فرابنفش (UV)', testMethod: 'ASTM D4329', unit: '-', typicalValue: '> 90% retention of tensile strength after 500 h QUV' }
  ],
  dataSheet: '/Product/Datasheet-Fa/UVCHEM MB-R18 Fa.pdf',
  msds: '/UVChem MB-R18 MSDS Fa.pdf',
}

// ─── Desktop accordion specs (same content as product.specs / sections) ──
const specs = ref([
  { id: 'typical_applications', title: 'کاربردهای متداول', content: product.detailSections[0].body, open: true },
  { id: 'advantage', title: 'مزایا', content: product.detailSections[1].body, open: true },
  { id: 'typical_addition_rate', title: 'میزان افزودن معمول', content: product.detailSections[2].body, open: true },
  { id: 'packaging', title: 'بسته‌بندی', content: product.detailSections[3].body, open: true },
  { id: 'storage_and_handling', title: 'نگهداری و جابجایی', content: product.detailSections[4].body, open: true },
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'UVCHEM MB-R18 – مستربچ پایدارکننده UV | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'UVCHEM MB-R18 مستربچ پایدارکننده اشعه فرابنفش با ترکیب HALS و جاذب UV برای رافیا و پارچه‌های بافته‌شده پلی‌پروپیلن با مقاومت بلندمدت در فضای باز.'
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/product-r18` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/product-r18` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/product-r18` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/product-r18` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/product-r18` },
  ],
  script: [
