...
const PAGE_PATH = '/fa/products/CALCICHEM-110-FRF'
...
const product = {
  ...
  subtitle: `CALCICHEM 110 FRF یک مستربچ پرکننده است که حاوی کربنات کلسیم (CaCO₃) با اندازه ذرات بسیار ریز و پوشش دار شده می باشد. برای استفاده در تولید فیلم ها، طناب، نخ‌های رافیا و قطعات تزریقی طراحی شده است.`,
  detailImage: '/Product/index/110-1.webp',
  heroImage: '/Product/index/110-1.webp',
  featureList: ['فیلم‌ها، طناب و نخ‌های رافیا', 'محصولات عمومی پلی‌اتیلن و پلی‌پروپیلن'],
  detailSections: [
...
▪ بهبود کیفیت چاپ روی محصول نهایی` },
    { title: 'بسته‌بندی', body: `CALCICHEM 110 FRF به‌شکل گرانول استاندارد بوده و در کیسه‌های 25 کیلوگرمی عرضه می‌شود.` },
    { title: 'نگهداری و جابجایی', body: `CALCICHEM 110 FRF باید دور از تابش مستقیم نور خورشید و حرارت نگهداری شود. حداکثر تا ۱۸ ماه پس از تولید استفاده گردد.` }
  ],
  specs: [
    { property: 'کربنات کلسیم', testMethod: '-', unit: '%', typicalValue: '80 ± 2' },
    { property: 'میزان رطوبت', testMethod: '-', unit: 'ppm', typicalValue: '≤ 1500' },
    { property: '(2.16kg / 230°C) شاخص جریان مذاب', testMethod: '-', unit: 'g/10min', typicalValue: '1.5 ± 1' },
    { property: '23 ˚C چگالی در', testMethod: '-', unit: 'g/cm³', typicalValue: '1.86 ± 0.05' }
  ],
  dataSheet: '/Product/Datasheet-Fa/CALCICHEM 110 FRF Fa.pdf',
  msds: '/CALCICHEM 110 FRF MSDS Fa.pdf',
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'CALCICHEM 110 FRF – مستربچ پرکننده کربنات کلسیم | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'CALCICHEM 110 FRF مستربچ پرکننده حاوی کربنات کلسیم ریز و پوشش‌دار برای فیلم، طناب و نخ رافیا با کاهش هزینه مواد اولیه و افزایش سرعت تولید.'
