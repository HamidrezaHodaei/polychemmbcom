...
<template>
  ...
  <div v-if="isMobile" class="page-wrap">
    ...
    <div class="content-below-navbar">
      <div class="px-5 pt-6 pb-4">
        <p class="text-[11px] tracking-widest text-gray-400 uppercase mb-1">{{ product.brand }}</p>
        <h2 class="text-2xl font-semibold text-gray-900 mb-4">{{ product.title }}</h2>
      ...
      <img :src="product.detailImage" alt="ROTOCHEM 0955W" class="w-full block" />

      <div class="bg-[#A8A8A8] text-white px-5 py-8">
        <h3 class="font-semibold tracking-widest text-lg mb-6 text-[#FFCD05]">مشخصات فنی</h3>
        <div class="space-y-3">
          <div
  ...
  <!-- ===================================================================== -->
  <!-- DESKTOP LAYOUT (same as original doc1)                                 -->
  <!-- ===================================================================== -->
    ...
    <div class="shell">
      <header class="header">
        <nav class="nav">
          ...
          <a class="nav-item effect-1-yellow" href="#" title="محصولات" @click.prevent="goToProducts">
      ...
      <main class="main-grid">
        <div class="left-col">
          <div class="hero-image">
            <img src="/Product/index/955w-p-2.jpg" alt="ROTOCHEM 0955W product photo" class="hero-photo" />
          </div>
        </div>
        ...
        <div class="right-col">
          ...
          <p class="desc">
            ROTOCHEM 0955W یک آمیزه پلیمری تخصصی سفید رنگ است که برای کاربردهای
            قالب‌گیری دورانی طراحی شده است. این محصول از کوپلیمر پلی‌اتیلن خطی با
            چگالی متوسط و توزیع وزن مولکولی باریک ساخته شده و با دی‌اکسید تیتانیوم
            (TiO₂) تقویت شده است. این آمیزه دارای ویژگی‌های فنی مطلوبی بوده و برای
            تولیدکنندگانی که به دنبال مواد قابل‌اعتماد، بادوام و پایدار در شرایط
            محیطی مختلف هستند، گزینۀ مناسبی به شمار می‌آید. این ماده در کاربردهای
            صنعتی و مصرفی مختلف به‌خاطر ثبات و عملکرد یکنواخت مورد استفاده قرار می‌گیرد.
          </p>

          <ul class="feature-list">
            <li>مخازن آب و ظروف نگهداری</li>
            <li>محصولات قالب‌گیری دورانی</li>
          </ul>
...
const PAGE_PATH = '/fa/products/0955W'
...
// ─── Product data (955W only) ─────────────────────────────────────
const product = {
  title: 'ROTOCHEM 0955W',
  brand: '',
  detailImage: '/Product/index/955w-p.jpg',
  heroImage: '/Product/index/955w-p.jpg',
  featureList: ['مخازن آب و ظروف نگهداری', 'محصولات قالب‌گیری دورانی'],
  detailSections: [
    { title: 'مزایا', body: `از ویژگی‌های ROTOCHEM 955W می توان به پراکندگی عالی، استحکام ضربه‌ای فوق‌العاده، کیفیت سطحی بالا در داخل و خارج محصول، مقاومت در برابر ترک‌خوردگی ناشی از تنش محیطی (ESCR) و پایداری مؤثر در برابر اشعه UV اشاره نمود.` },
    { title: 'بسته‌بندی', body: `ROTOCHEM 955W به صورت پودر و در کیسه‌های ۲۰ کیلوگرمی ارسال می گردد.` },
    { title: 'نگهداری و جابجایی', body: `توصیه می شود ROTOCHEM 955W به دور از تابش مستقیم نور خورشید و گرما نگهداری شود. محیط نگهداری باید خشک بوده و دمای آن ترجیحاً از ۵۰ درجه سانتی‌گراد تجاوز نکند. بهترین زمان استفاده از ROTOCHEM 955W حداکثر تا ۱۸ ماه پس از تاریخ تولید می باشد.` }
  ],
  specs: [
    { property: '(190 C /2.16 kg) شاخص جریان مذاب', testMethod: 'ASTM D1238-7', unit: 'g/10min', typicalValue: '3.5 ± 0.5' },
    { property: '23 ˚C چگالی در', testMethod: 'ASTM D1505-68', unit: 'kg/m³', typicalValue: '0.937 – 0.945' },
    { property: '(TiO₂) نوع ساختار', testMethod: '-', unit: '-', typicalValue: 'Rutile type' },
    { property: '(TiO₂) میزان', testMethod: '-', unit: '%', typicalValue: '2' },
    { property: 'میزان رطوبت', testMethod: '-', unit: 'ppm', typicalValue: '≤ 1500' },
    { property: '(Vicat) نقطه نرمی', testMethod: 'ASTM D1525', unit: '°C', typicalValue: '115' },
    { property: 'استحکام کششی در نقطه تسلیم', testMethod: 'ASTM D638 - 72', unit: 'MPa', typicalValue: '15' },
    { property: 'درصد افزایش طول در نقطه شکست', testMethod: 'ASTM D638', unit: '%', typicalValue: '> 700' },
    { property: 'مدول خمشی', testMethod: 'ASTM D790', unit: 'MPa', typicalValue: '650' },
    { property: 'سختی', testMethod: 'ASTM D2240', unit: 'Shore D', typicalValue: '65' },
    { property: 'مقاومت در برابر ترک خوردگی تنشی محیطی', testMethod: 'ASTM D1693', unit: 'HR', typicalValue: '200' }
  ],
  dataSheet: '/Product/Datasheet-Fa/ROTOCHEM 955W Fa.pdf',
  msds: '/0955W MSDS Fa.pdf',
}

// ─── Desktop accordion specs (same content as product.specs / sections) ──
const specs = ref([
  { id: 'advantage', title: 'مزایا', content: product.detailSections[0].body, open: true },
  { id: 'packaging', title: 'بسته‌بندی', content: product.detailSections[1].body, open: true },
  { id: 'storage', title: 'نگهداری و جابجایی', content: product.detailSections[2].body, open: true },
  { id: 'techspecs', title: 'مشخصات فنی', isTable: true, open: true },
])
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'ROTOCHEM 0955W – آمیزه پلیمری سفید قالب‌گیری دورانی | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'ROTOCHEM 0955W آمیزه‌ای پلیمری سفید برای قالب‌گیری دورانی با پایداری عالی، مقاومت UV و کیفیت سطحی یکنواخت برای صنایع مختلف.'
...
const breadcrumbJsonLd = computed(() => ({
  ...
  '@type': 'BreadcrumbList',
  itemListElement: [
    { '@type': 'ListItem', position: 1, name: 'خانه', item: `${SITE_URL}/fa` },
    { '@type': 'ListItem', position: 2, name: 'محصولات', item: `${SITE_URL}/fa/products` },
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/product-955w` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/product-955w` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/product-955w` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/product-955w` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/product-955w` },
  ],
  script: [
...
/* Same slide animation, colors reversed: yellow background -> white on hover */
.btn-slide-down-reverse {
  position: relative;
  overflow: hidden;
  background-color: #FFCD05;
  color: #ffffff;
...
.btn-slide-down-reverse:hover,
.btn-slide-down-reverse:focus-visible { border-color: #FFCD05; }
.btn-slide-down-reverse::before {
  content: '';
  position: absolute;
  left: 0; top: 0;
  width: 100%; height: 100%;
...
.btn-slide-down-reverse:hover::before,
.btn-slide-down-reverse:focus-visible::before { transform: translateY(0); }
.btn-slide-down-reverse:hover,
.btn-slide-down-reverse:focus-visible { color: #FFCD05; outline: none; }
.btn-slide-down-reverse > span { position: relative; z-index: 1; }
...
.page-wrap {
  ...
  background: #f1f2f2;
  font-family: 'IRANYekan', 'Montserrat', 'Tahoma', sans-serif;
  direction: rtl;
  text-align: right;
}
...
/* ===================================================================== */
/* DESKTOP — identical to original doc1 markup/styles                     */
/* ===================================================================== */
.page {
  min-height: 100vh;
  background: #f1f2f2;
...
/* Desktop dropdown panels (products / Language) */
.desktop-menu-panel {
  position: absolute;
  top: 78px;
  left: 0;
...
.spec-text { font-size: 14px; line-height: 1.7; color: #444; margin: 0; }
...
.desc { font-size: 16px; line-height: 1.6; color: #4b5563; margin: 0 0 16px; max-width: 560px; }
