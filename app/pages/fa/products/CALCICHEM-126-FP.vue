...
const PAGE_PATH = '/fa/products/CALCICHEM-126-FP'
...
// ─── Product data (CALCICHEM 126 FP only) ─────────────────────────────────
const product = {
  title: 'CALCICHEM 126 FP',
  brand: '',
  subtitleTitle: 'توضیحات',
  subtitle: `CALCICHEM 126 FP یک مستربچ پرکننده بر پایه پلی‌پروپیلن است که حاوی ۸۰٪ کربنات کلسیم (CaCO₃) با اندازه ذرات بسیار ریز و پوشش دار شده می باشد.`,
  detailImage: '/Product/index/calcum-126.webp',
  heroImage: '/Product/index/calcum-126.webp',
  featureList: ['اکستروژن و قالب‌گیری تزریقی پلی‌اولفین', 'کاربردهای عمومی پرکننده'],
  detailSections: [
    { title: 'مزایا', body: `▪ افزایش سرعت در تولید
▪ کاهش میزان جذب رطوبت
▪ بهبود رسانایی حرارتی
▪ افزایش خاصیت ضد چسبندگی (Anti-blocking)
▪ بهبود قابلیت چاپ بر روی محصول نهایی
▪ پایداری عملکرد در طول فرایند تولید` },
    { title: 'بسته‌بندی', body: `CALCICHEM 126 FP به‌صورت پلت استاندارد و در کیسه‌های 25 کیلوگرمی عرضه می‌شود.` },
    { title: 'نگهداری و جابجایی', body: `CALCICHEM 126 FP باید دور از تابش مستقیم نور خورشید و حرارت نگهداری شود. حداکثر تا ۱۸ ماه پس از تولید استفاده گردد.` }
  ],
  specs: [
    { property: 'درصد کربنات کلسیم', testMethod: 'ASTM D4218', unit: '%', typicalValue: '80 ± 2' },
    { property: 'میزان رطوبت', testMethod: 'ASTM D644', unit: 'ppm', typicalValue: '≤ 1500' },
    { property: '(2.16kg / 230°C) شاخص جریان مذاب', testMethod: 'ASTM D1238', unit: 'g/10min', typicalValue: '6 ± 2' },
    { property: '23 ˚C چگالی در', testMethod: 'ASTM D1505', unit: 'g/cm³', typicalValue: '1.85 ± 0.05' }
  ],
  dataSheet: '/Product/Datasheet-Fa/CALCICHEM 126 FP Fa.pdf',
  msds: '/CALCICHEM 126 FP MSDS Fa.pdf',
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'CALCICHEM 126 FP – مستربچ پرکننده پلی‌پروپیلن | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'CALCICHEM 126 FP مستربچ پرکننده بر پایه پلی‌پروپیلن با ۸۰٪ کربنات کلسیم، بهبود سرعت تولید، رسانایی حرارتی و کیفیت چاپ.'
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/product-126fp` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/product-126fp` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/product-126fp` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/product-126fp` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/product-126fp` },
  ],
  script: [
