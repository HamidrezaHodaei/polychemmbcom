...
const PAGE_PATH = '/fa/products/HDCHEM-4760'
...
// ─── Product data (HDCHEM 4760 only) ─────────────────────────────────
const product = {
  title: 'HDCHEM 4760',
  brand: '',
  subtitleTitle: 'توضیحات',
  subtitle: `HDCHEM 4760 یک کامپاند پلاستیکی تخصصی است که برای کاربردهای قالب‌گیری بادی (Blow Molding) طراحی شده است. این محصول ترکیبی از کوپلیمرهای پلی‌اتیلنی بوده و دارای مجموعه‌ای از ویژگی‌های مطلوب و کاربردی است.`,
  detailImage: '/Product/index/Hdchem-2.webp',
  heroImage: '/Product/index/Hdchem-2.webp',
  featureList: ['ظروف تولید شده به روش قالب‌گیری بادی', 'کاربردهای بسته‌بندی صلب'],
  detailSections: [
    { title: 'مزایا', body: `از ویژگی‌های HDCHEM 4760 می توان به جریان‌پذیری مناسب، استحکام ضربه‌ای بالا، مقاومت مناسب در برابر ترک‌خوردگی ناشی از تنش محیطی (ESCR) و سختی مطلوب اشاره نمود.` },
    { title: 'بسته‌بندی', body: `HDCHEM 4760 به‌صورت گرانول و در کیسه‌های ۲۵ کیلوگرمی عرضه می‌شود.` },
    { title: 'نگهداری و جابجایی', body: `توصیه می شود HDCHEM 4760 به دور از تابش مستقیم نور خورشید و گرما نگهداری شود. بهترین زمان استفاده حداکثر تا ۱۲ ماه پس از تولید می باشد.` }
  ],
  specs: [
    { property: '(190°C /5 kg) شاخص جریان مذاب', testMethod: 'ISO 1133', unit: 'g/10min', typicalValue: '1.2 ± 0.5' },
    { property: '23 ˚C چگالی در', testMethod: 'ISO 1183', unit: 'kg/m³', typicalValue: '0.954 ± 0.002' },
    ...
    { property: '(23 ºC) مقاومت ضربه', testMethod: 'ISO 179/1eA', unit: 'mJ/mm²', typicalValue: '9' },
    { property: 'سختی', testMethod: 'ASTM D2240', unit: 'Shore D', typicalValue: '62' }
  ],
  dataSheet: '/Product/Datasheet-Fa/HDCHEM 4760 Fa.pdf',
  msds: '/HDCHEM 4760 MSDS Fa.pdf',
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'HDCHEM 4760 – کامپاند قالب‌گیری بادی HDPE | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'HDCHEM 4760 کامپاند کوپلیمر پلی‌اتیلن برای قالب‌گیری بادی با جریان‌پذیری مناسب، استحکام ضربه‌ای بالا و مقاومت ESCR مطلوب.'
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/product-4760` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/product-4760` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/product-4760` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/product-4760` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/product-4760` },
  ],
  script: [
