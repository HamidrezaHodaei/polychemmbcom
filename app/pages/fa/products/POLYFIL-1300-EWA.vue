...
const PAGE_PATH = '/fa/products/POLYFIL-1300-EWA'
...
const product = {
  ...
  subtitle: `POLYFILL 1300 EWA به‌طور ویژه برای استفاده در فرمولاسیون‌های پایه پلی‌اتیلن طراحی شده و قابلیت به‌کارگیری در طیف گسترده‌ای از فرآیندهای تولید فیلم و بسته‌بندی را فراهم می‌کند. از این گرید می‌توان در تولید فیلم‌های بسته‌بندی پلی‌اتیلنی با سطح مصرف تقریبی ۵ تا ۴۰ درصد بسته به ضخامت فیلم و الزامات فنی بهره برد. همچنین در تولید کیسه‌های خرید پلی‌اتیلنی محدوده مصرف معمول بین ۲۰ تا ۵۰ درصد بوده و در کاربردهای لمینیشن و کوتینگ پلی‌اتیلن نیز این میزان عموماً در بازه ۵ تا ۳۰ درصد قرار می‌گیرد.`,
  detailImage: '/Product/index/1300.webp',
  heroImage: '/Product/index/1300.webp',
  featureList: ['فیلم و کیسه‌های بسته‌بندی پلی‌اتیلنی', 'لمینیشن و کوتینگ پلی‌اتیلن'],
  detailSections: [
    { title: 'مزایا', body: `• کاهش مصرف انرژی
• بهبود رسانایی حرارتی
• افزایش خاصیت آنتی‌بلاک
• بهبود کیفیت چاپ روی محصول نهایی
• افزایش سرعت در تولید
• بهبود سفتی و مدول کششی
• بهبود مقاومت پارگی
• افزایش دانسیته و بهره‌وری تولید
• جایگزینی بخشی از پلیمر و کاهش هزینه تولید
• کاهش هزینه مواد اولیه` },
    { title: 'بسته‌بندی', body: `POLYFILL 1300 EWA به‌ شکل گرانول استاندارد بوده و در کیسه‌های 25 کیلوگرمی عرضه می‌شود.` },
    { title: 'نگهداری و حمل و نقل', body: `POLYFILL 1300 EWA باید دور از تابش مستقیم نور خورشید و حرارت نگهداری شود. این مواد در محل خشک و در دمای پایین تر از ۵۰ درجه سانتی‌گراد نگهداری شود. شرایط نگهداری نامناسب ممکن است منجر به کاهش کیفیت و عملکرد محصول گردد. توصیه می‌شود قبل از مصرف خشک شود و حداکثر تا ۱۸ ماه پس از تولید استفاده گردد.` }
  ],
  specs: [
    { property: 'CaCO3', testMethod: 'ASTM D 4218', unit: '%', typicalValue: '82 ± 1' },
    { property: 'میزان رطوبت', testMethod: 'ASTM D 6980-17', unit: '%', typicalValue: '≤ 0.1' },
    { property: '(C/5 kg °190) شاخص جریان مذاب', testMethod: 'ASTM D 1238', unit: 'g/10min', typicalValue: '3±0.5' },
    { property: '23 °C چگالی در', testMethod: 'ASTM D 1505', unit: 'g/cm³', typicalValue: '1.9' }
  ],
  dataSheet: '/Product/Datasheet-Fa/POLYFILL 1300 EWA Fa.pdf',
  msds: '/POLYFILL 1300 EWA MSDS Fa.pdf',
}
...
const specs = ref([
  ...
  { id: 'storage_and_handling', title: 'نگهداری و حمل و نقل', content: product.detailSections[2].body, open: true },
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'POLYFILL 1300 EWA – مستربچ کربنات سفره  | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'POLYFILL 1300 EWA مستربچ پرکننده بر پایه پلی‌اتیلن با ۸۲٪ کربنات کلسیم برای فیلم و کیسه بسته‌بندی و لمینیشن، با بهبود سفتی و بهره‌وری تولید.'
...
useHead({
  link: [
    ...
    { rel: 'alternate', hreflang: 'en', href: `${SITE_URL}/en/product-1300ewa` },
    { rel: 'alternate', hreflang: 'fa', href: `${SITE_URL}/fa/product-1300ewa` },
    { rel: 'alternate', hreflang: 'ar', href: `${SITE_URL}/ar/product-1300ewa` },
    { rel: 'alternate', hreflang: 'tr', href: `${SITE_URL}/tr/product-1300ewa` },
    { rel: 'alternate', hreflang: 'x-default', href: `${SITE_URL}/en/product-1300ewa` },
  ],
  script: [
