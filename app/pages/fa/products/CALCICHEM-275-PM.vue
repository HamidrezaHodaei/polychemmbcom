...
const PAGE_PATH = '/fa/products/CALCICHEM-275-PM'
...
const product = {
  ...
  subtitle: `CALCICHEM 275 PM یک مستربچ پرکننده بر پایه پلی‌پروپیلن است که پراکنش و پراکندگی عالی را در محصول نهایی تضمین می‌کند. به‌طور ویژه برای استفاده مستقیم در فرایند اکستروژن فیلم‌های BOPP، CPP و OPP طراحی شده است.`,
  detailImage: '/Product/index/275-1.webp',
  heroImage: '/Product/index/275-1.webp',
  featureList: ['اکستروژن فیلم‌های BOPP، CPP و OPP', 'کاربردهای فیلم با عملکرد بالا'],
  detailSections: [
    { title: 'مزایا', body: `▪ یکنواختی و کیفیت پایدار در فرآیند تولید
▪ مناسب برای تولید فیلم با سرعت بالا` },
    { title: 'بسته‌بندی', body: `CALCICHEM 275 PM به‌شکل گرانول استاندارد بوده و در کیسه‌های 25 کیلوگرمی عرضه می‌شود.` },
    { title: 'نگهداری و جابجایی', body: `CALCICHEM 275 PM باید دور از تابش مستقیم نور خورشید و حرارت نگهداری شود. حداکثر تا ۱۸ ماه پس از تولید استفاده گردد.` }
  ],
  specs: [
    { property: 'مقدار خاکستر', testMethod: '-', unit: '%', typicalValue: '75 ± 1' },
    { property: 'متوسط اندازه ذرات (d50%)', testMethod: '-', unit: 'μm', typicalValue: '≤ 2' },
    { property: 'میزان رطوبت', testMethod: '-', unit: 'ppm', typicalValue: '≤ 1500' },
    { property: '(2.16kg / 230°C) شاخص جریان مذاب', testMethod: '-', unit: 'g/10min', typicalValue: '3 ± 1' },
    { property: '23 ˚C چگالی در', testMethod: '-', unit: 'g/cm³', typicalValue: '1.75 ± 0.05' }
  ],
  dataSheet: '/Product/Datasheet-Fa/CALCICHEM 275 PM Fa.pdf',
  msds: '',
}
...
// ───────────────────────────────────────────────────────────────────
const pageTitle = 'CALCICHEM 275 PM – مستربچ پرکننده برای فیلم BOPP/CPP/OPP | پلیکم (پلیمر شیمی ارس)'
const pageDescription = 'CALCICHEM 275 PM مستربچ پرکننده بر پایه پلی‌پروپیلن با پراکندگی عالی، مناسب برای اکستروژن فیلم‌های BOPP، CPP و OPP با سرعت بالا.'
