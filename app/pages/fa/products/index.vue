  ...
  <div class="page" dir="rtl">
    <div class="wrap">
      <div class="brand-header">
        <img src="/Polychem-1.png" alt="لوگوی پلی‌کم" class="brand-logo brand-logo--mobile" />
      </div>
      ...
      <div class="toolbar">
        ...
        <div class="search-box">
          ...
          />
          <button class="search-go" @click="searchQuery = searchQuery">جستجو</button>
        </div>
      </div>
...
useHead({
  title: 'محصولات | پلیکم (پلیمر شیمی ارس)',
  link: [
...
const tabs = ['همه', 'مستربچ پرکننده', 'مستربچ رنگی', 'مستربچ افزودنی', 'کامپاند']
...
const items = ref([
  {
    id: 1,
    name: 'ROTOCHEM 0955W',
    description: 'آمیزه پلیمری تخصصی سفید برای قالب‌گیری دورانی با پایداری عالی در برابر اشعه UV و کیفیت سطحی یکنواخت.',
    category: 'کامپاند',
  ...
  },
  {
    id: 2,
    name: 'ROTOCHEM 0955B',
    description: 'آمیزه پلیمری آبی رنگ برای قالب‌گیری دورانی، مناسب تولید قطعاتی بادوام، براق و مقاوم در برابر ضربه.',
    category: 'کامپاند',
  ...
  },
  {
    id: 3,
    name: 'POLYFIL F700',
    description: 'کامپاند پلی‌اتیلن با عملکرد بالا برای فیلم دمشی HDPE با یکنواختی عالی.',
    category: 'کامپاند',
  ...
  },
  {
    id: 4,
    name: 'SLIPCHEM E 178',
    description: 'مستربچ لیزکننده برای کاهش اصطکاک در پیچش فیلم، تولید کیسه و فرآیندهای بسته‌بندی.',
    category: 'مستربچ افزودنی',
  ...
  },
  {
    ...
    description: 'مستربچ پرکننده کربنات کلسیم برای بهبود سفتی، بهره‌وری و دانسیته در کاربردهای پلی‌اتیلن.',
    category: 'مستربچ پرکننده',
  ...
  },
  {
    id: 6,
    name: 'HDCHEM 4760',
    description: 'کامپاند قالب‌گیری بادی با جریان‌پذیری مناسب، استحکام ضربه‌ای، سختی و عملکرد ESCR مطلوب.',
    category: 'کامپاند',
  ...
  },
  {
    id: 7,
    name: 'RAFCOLOR 1560',
    description: 'مستربچ سفید با غلظت بالا برای رافیا، نوار و محصولات بافته‌شده با پراکندگی عالی.',
    category: 'مستربچ رنگی',
  ...
  },
  {
    ...
    description: 'مستربچ پرکننده بر پایه پلی‌پروپیلن با میزان بالای کربنات کلسیم برای بهره‌وری و کیفیت تولید.',
    category: 'مستربچ پرکننده',
  ...
  },
  {
    ...
    description: 'اصلاح‌کننده معدنی طراحی‌شده برای فیلم، رافیا و طناب با تعادل عالی هزینه و عملکرد.',
    category: 'مستربچ پرکننده',
  ...
  },
  {
    ...
    description: 'مستربچ معدنی با عملکرد بالا، متناسب با اکستروژن فیلم‌های BOPP، CPP و OPP.',
    category: 'مستربچ پرکننده',
  ...
  },
  {
    id: 11,
    name: 'UVCHEM MB R18',
    description: 'مستربچ پایدارکننده UV که دوام در فضای باز و پایداری رنگ محصولات پلی‌پروپیلن را بهبود می‌بخشد.',
    category: 'مستربچ افزودنی',
...
// دکمه‌ی مشاهده محصول - بر اساس نام فایل صفحه‌ی محصول هدایت می‌شود
function goToProduct(item) {
  const entry = productFileMap[item.name]
  const target = entry ? `/fa/${entry.dir}/${entry.slug}` : `/fa/products/${encodeURIComponent(item.name)}`
